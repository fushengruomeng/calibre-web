    ...
    var touchStart = 0;
        ...
        return function(t) {
            ...
            function g(t, e, i, n, s) {
                var r, o = n || 0, a = s || e.length, h = parseInt(o + (a - o) / 2);
            ...
            function x(t, e) {
                for (var i, n = t.parentNode.childNodes, s = -1, r = 0; r < n.length && ((i = n[r]).nodeType === e && s++,
                i != t); r++)
                    ;
                return s
            }
            ...
            function R(t, e, i) {
                var s;
                return s = "undefined" == typeof DOMParser || i ? n.DOMParser : DOMParser,
            ...
            function L(t, e, i) {
                ...
                if (n = t.getElementsByTagName(e),
                    s = Array.prototype.slice.call(n, 0).filter((function(t) {
                            for (var e in i)
                                if (t.getAttribute(e) === i[e])
                                    return !0;
                            return !1
                        }
                    )))
            ...
            function B(t, e, i) {
                var n;
                if (void 0 !== t.querySelector && (n = t.querySelector(`${e}[*|type="${i}"]`)),
                n && 0 !== n.length)
                    return n;
                n = A(t, e);
                for (var s = 0; s < n.length; s++)
                    if (n[s].getAttributeNS("http://www.idpf.org/2007/ops", "type") === i || n[s].getAttribute("epub:type") === i)
                        return n[s]
            }
            function q(t) {
            ...
            class H {
                ...
                setEnd(t, e) {
                    this.endContainer = t,
                        this.endOffset = e,
                        this.startContainer ? (this.collapsed = !1,
                            this.commonAncestorContainer = this._commonAncestorContainer()) : this.collapse(!1),
                        this._checkCollapsed()
                }
                collapse(t) {
                    this.collapsed = !0,
                        t ? (this.endContainer = this.startContainer,
                            this.endOffset = this.startOffset,
                            this.commonAncestorContainer = this.startContainer.parentNode) : (this.startContainer = this.endContainer,
                ...
                class s {
                    constructor(t, e, i) {
                        ...
                        if (this.str = "",
                            ...
                            !(this instanceof s))
                            return new s(t,e,i);
                        if ("string" == typeof e ? this.base = this.parseComponent(e) : "object" == typeof e && e.steps && (this.base = e),
                    ...
                    parse(t) {
                        ...
                        return "string" != typeof t ? {
                            ...
                            (e = this.getChapterComponent(t)) ? (s.base = this.parseComponent(e),
                                i = this.getPathComponent(t),
                                s.path = this.parseComponent(i),
                            (n = this.getRange(t)) && (s.range = !0,
                    ...
                    parseComponent(t) {
                        ...
                        }, n = t.split(":"), s = n[0].split("/");
                        return n.length > 1 && (e = n[1],
                            i.terminal = this.parseTerminal(e)),
                        "" === s[0] && s.shift(),
                            i.steps = s.map(function(t) {
                    ...
                    parseStep(t) {
                        var e, i, n, s, r;
                        if ((s = t.match(/\[(.*)\]/)) && s[1] && (r = s[1]),
                            i = parseInt(t),
                            !isNaN(i))
                            return i % 2 == 0 ? (e = "element",
                                n = i / 2 - 1) : (e = "text",
                                n = (i - 1) / 2),
                                {
                                    type: e,
                    ...
                    parseTerminal(t) {
                        var e, i, s = t.match(/\[(.*)\]/);
                        return s && s[1] ? (e = parseInt(t.split("[")[0]),
                            i = s[1]) : e = parseInt(t),
                    ...
                    joinSteps(t) {
                        return t ? t.map((function(t) {
                                var e = "";
                                return "element" === t.type && (e += 2 * (t.index + 1)),
                    ...
                    segmentString(t) {
                        var e = "/";
                        return e += this.joinSteps(t.steps),
                    ...
                    toString() {
                        var t = "epubcfi(";
                        return t += this.segmentString(this.base),
                            t += "!",
                            t += this.segmentString(this.path),
                        this.range && this.start && (t += ",",
                            t += this.segmentString(this.start)),
                        this.range && this.end && (t += ",",
                            t += this.segmentString(this.end)),
                            t += ")"
                    }
                    compare(t, e) {
                        var i, n, r, o;
                        if ("string" == typeof t && (t = new s(t)),
                        "string" == typeof e && (e = new s(e)),
                        t.spinePos > e.spinePos)
                            return 1;
                        if (t.spinePos < e.spinePos)
                            return -1;
                        t.range ? (i = t.path.steps.concat(t.start.steps),
                            r = t.start.terminal) : (i = t.path.steps,
                            r = t.path.terminal),
                            e.range ? (n = e.path.steps.concat(e.start.steps),
                                o = e.start.terminal) : (n = e.path.steps,
                                o = e.path.terminal);
                    ...
                    filteredStep(t, e) {
                        ...
                        if (n)
                            return i = 3 === n.nodeType ? "text" : "element",
                                {
                                    id: n.id,
                                    tagName: n.tagName,
                                    type: i,
                    ...
                    pathTo(t, e, i) {
                        ...
                        }, r = t; r && r.parentNode && 9 != r.parentNode.nodeType; )
                            (n = i ? this.filteredStep(r, i) : this.step(r)) && s.steps.unshift(n),
                                r = r.parentNode;
                        return null != e && e >= 0 && (s.terminal.offset = e,
                        "text" != s.steps[s.steps.length - 1].type && s.steps.push({
                            type: "text",
                            index: 0
                        })),
                            s
                    ...
                    fromRange(t, e, i) {
                        var n = {
                            ...
                            , a = t.endOffset
                            , h = !1;
                        if (i && (h = null != s.ownerDocument.querySelector("." + i)),
                            "string" == typeof e ? (n.base = this.parseComponent(e),
                                n.spinePos = n.base.steps[1].index) : "object" == typeof e && (n.base = e),
                            t.collapsed)
                            ...
                            for (l = 0; l < c && this.equalStep(n.start.steps[l], n.end.steps[l]); l++)
                                l === c - 1 ? n.start.terminal === n.end.terminal && (n.path.steps.push(n.start.steps[l]),
                                    n.range = !1) : n.path.steps.push(n.start.steps[l]);
                    ...
                    fromNode(t, e, i) {
                        ...
                        return "string" == typeof e ? (n.base = this.parseComponent(e),
                            n.spinePos = n.base.steps[1].index) : "object" == typeof e && (n.base = e),
                    ...
                    filter(t, e) {
                        var i, n, s, r, o, a = !1;
                        return 3 === t.nodeType ? (a = !0,
                            s = t.parentNode,
                            i = t.parentNode.classList.contains(e)) : (a = !1,
                            i = t.classList.contains(e)),
                            i && a ? (r = s.previousSibling,
                                o = s.nextSibling,
                    ...
                    patchOffset(t, e, i) {
                        ...
                        for (t.parentNode.classList.contains(i) && (n = t.parentNode); n.previousSibling; ) {
                            if (1 === n.previousSibling.nodeType) {
                                if (!n.previousSibling.classList.contains(i))
                                    break;
                    ...
                    normalizedMap(t, e, i) {
                        var n, s, r, o = {}, a = -1, h = t.length;
                        for (n = 0; n < h; n++)
                            1 === (s = t[n].nodeType) && t[n].classList.contains(i) && (s = 3),
                                n > 0 && 3 === s && 3 === r ? o[n] = a : e === s && (a += 1,
                                    o[n] = a),
                                r = s;
                        return o
                    }
                    position(t) {
                        var e, i;
                        return 1 === t.nodeType ? ((e = t.parentNode.children) || (e = Object(n.findChildren)(t.parentNode)),
                            i = Array.prototype.indexOf.call(e, t)) : i = (e = this.textNodes(t.parentNode)).indexOf(t),
                            i
                    }
                    filteredPosition(t, e) {
                        var i, n;
                        return 1 === t.nodeType ? (i = t.parentNode.children,
                            n = this.normalizedMap(i, 1, e)) : (i = t.parentNode.childNodes,
                    ...
                    walkToNode(t, e, i) {
                        var s, r, o = e || document, a = o.documentElement, h = t.length;
                        for (r = 0; r < h && ("element" === (s = t[r]).type ? a = s.id ? o.getElementById(s.id) : (a.children || Object(n.findChildren)(a))[s.index] : "text" === s.type && (a = this.textNodes(a, i)[s.index]),
                            a); r++)
                            ;
                        return a
                    }
                    findNode(t, e, i) {
                        ...
                        return i || void 0 === r.evaluate ? n = i ? this.walkToNode(t, r, i) : this.walkToNode(t, r) : (s = this.stepsToXpath(t),
                            n = r.evaluate(s, r, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue),
                            n
                    }
                    fixMiss(t, e, i, n) {
                        var s, r, o = this.findNode(t.slice(0, -1), i, n), a = o.childNodes, h = this.normalizedMap(a, 3, n), l = t[t.length - 1].index;
                        for (let t in h) {
                    ...
                    toRange(t, e) {
                        var i, s, r, o, a, h, l, c, u = t || document, d = !!e && null != u.querySelector("." + e);
                        if (i = void 0 !== u.createRange ? u.createRange() : new n.RangeObject,
                            this.range ? (s = this.start,
                                h = this.path.steps.concat(s.steps),
                                o = this.findNode(h, u, d ? e : null),
                                r = this.end,
                                l = this.path.steps.concat(r.steps),
                                a = this.findNode(l, u, d ? e : null)) : (s = this.path,
                                h = this.path.steps,
                                o = this.findNode(this.path.steps, u, d ? e : null)),
                            !o)
                            return console.log("No startContainer found for", this.toString()),
                                null;
                        try {
                    ...
                    generateChapterComponent(t, e, i) {
                        var n = "/" + 2 * (t + 1) + "/";
                        return n += 2 * (parseInt(e) + 1),
                        i && (n += "[" + i + "]"),
                            n
                    }
                    collapse(t) {
                        this.range && (this.range = !1,
                            t ? (this.path.steps = this.path.steps.concat(this.start.steps),
                                this.path.terminal = this.start.terminal) : (this.path.steps = this.path.steps.concat(this.end.steps),
            ...
            , function(t, e, i) {
                "use strict";
                var n, s, r, o, a, h, l, c = i(31), u = i(45), d = Function.prototype.apply, f = Function.prototype.call, p = Object.create, g = Object.defineProperty, m = Object.defineProperties, v = Object.prototype.hasOwnProperty, y = {
                    configurable: !0,
                    enumerable: !1,
                    writable: !0
                };
                s = function(t, e) {
                    ...
                    return u(e),
                        s = this,
                        n.call(this, t, i = function() {
                                r.call(s, t, i),
                                    d.call(e, this, arguments)
                            }
                        ),
                    ...
                    a = {
                        on: n = function(t, e) {
                            var i;
                            return u(e),
                                v.call(this, "__ee__") ? i = this.__ee__ : (i = y.value = p(null),
                                    g(this, "__ee__", y),
                                    y.value = null),
                        ...
                        off: r = function(t, e) {
                            ...
                            if ("object" == typeof (n = i[t]))
                                ...
                                n !== e && n.__eeOnceListener__ !== e || delete i[t];
                            return this
                        }
                        ,
                        emit: o = function(t) {
            ...
            , function(t, e, i) {
                ...
                e.a = class {
                    ...
                    resolve(t) {
                        var e;
                        return t.indexOf("://") > -1 ? t : (e = r.a.resolve(this.directory, t),
                        this.origin + e)
                    }
                    relative(t) {
                    ...
                    for (var i, n = "", s = -1, r = 0, o = 0; o <= t.length; ++o) {
                        ...
                        if (47 === i) {
                            if (s === o - 1 || 1 === r)
                                ...
                                n.length > 0 ? n += "/" + t.slice(s + 1, o) : n = t.slice(s + 1, o);
                            s = o,
                                r = 0
                        } else
                            46 === i && -1 !== r ? ++r : r = -1
                ...
                var o = {
                    resolve: function() {
                        for (var t, e = "", i = !1, o = arguments.length - 1; o >= -1 && !i; o--) {
                            var a;
                            o >= 0 ? a = arguments[o] : (void 0 === t && (t = n.cwd()),
                                a = t),
                                s(a),
                            0 !== a.length && (e = a + "/" + e,
                                i = 47 === a.charCodeAt(0))
                    ...
                    relative: function(t, e) {
                        ...
                        for (var h = e.length - a, l = r < h ? r : h, c = -1, u = 0; u <= l; ++u) {
                            if (u === l) {
                                if (h > l) {
                                    ...
                                    r > l && (47 === t.charCodeAt(i + u) ? c = u : 0 === u && (c = 0));
                                break
                            }
                            var d = t.charCodeAt(i + u);
                            if (d !== e.charCodeAt(a + u))
                                break;
                            47 === d && (c = u)
                        }
                        var f = "";
                        ...
                        return f.length > 0 ? f + e.slice(a + c) : (a += c,
                        47 === e.charCodeAt(a) && ++a,
                            e.slice(a))
                    },
                        ...
                        if (void 0 !== e && e.length > 0 && e.length <= t.length) {
                            ...
                            for (i = t.length - 1; i >= 0; --i) {
                                ...
                                if (47 === l) {
                                    ...
                                    -1 === h && (o = !1,
                                        h = i + 1),
                                    a >= 0 && (l === e.charCodeAt(a) ? -1 == --a && (r = i) : (a = -1,
                                        r = h))
                            }
                            return n === r ? r = h : -1 === r && (r = t.length),
                                t.slice(n, r)
                        }
                        for (i = t.length - 1; i >= 0; --i)
                    ...
                    parse: function(t) {
                        ...
                        return -1 === o || -1 === h || 0 === u || 1 === u && o === h - 1 && o === a + 1 ? -1 !== h && (e.base = e.name = 0 === a && r ? t.slice(1, h) : t.slice(a, h)) : (0 === a && r ? (e.name = t.slice(1, o),
                            e.base = t.slice(1, h)) : (e.name = t.slice(a, o),
                            e.base = t.slice(a, h)),
                            e.ext = t.slice(o, h)),
            ...
            , function(t, e, i) {
                ...
                i(4);
                function r(t, e) {
                    var i, s, r = e.url, o = r.indexOf("://") > -1;
                    t && (s = Object(n.qs)(t, "head"),
                    (i = Object(n.qs)(s, "base")) || (i = t.createElement("base"),
                ...
                function o(t, e) {
                    ...
                    t && (i = Object(n.qs)(t, "head"),
                        (s = Object(n.qs)(i, "link[rel='canonical']")) ? s.setAttribute("href", r) : ((s = t.createElement("link")).setAttribute("rel", "canonical"),
                ...
                function a(t, e) {
                    var i, s, r = e.idref;
                    t && (i = Object(n.qs)(t, "head"),
                        (s = Object(n.qs)(i, "link[property='dc.identifier']")) ? s.setAttribute("content", r) : ((s = t.createElement("meta")).setAttribute("name", "dc.identifier"),
                        ...
                        for (var r = Object(n.qs)(t.ownerDocument, "base"), o = r ? r.getAttribute("href") : void 0, a = function(t) {
                            ...
                            if (0 !== i.indexOf("mailto:"))
                                if (i.indexOf("://") > -1)
                                    ...
                                    t.onclick = function() {
                                        return n && n.hash ? e(n.Path.path + n.hash) : e(n ? n.Path.path : i),
                                            !1
                                    }
                                }
                        }
                            .bind(this), h = 0; h < i.length; h++)
                            a(i[h])
                }
                function l(t, e, i) {
                    return e.forEach((function(e, n) {
                            e && i[n] && (e = e.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"),
            ...
            , function(t, e, i) {
                ...
                e.a = class {
                    ...
                    enqueue() {
                        var t, e, i = [].shift.call(arguments), s = arguments;
                        if (!i)
                    ...
                    dequeue() {
                        var t, e, i;
                        return !this._q.length || this.paused ? ((t = new n.defer).deferred.resolve(),
                            t.promise) : (e = (t = this._q.shift()).task) ? (i = e.apply(this.context, t.args)) && "function" == typeof i.then ? i.then(function() {
                            t.deferred.resolve.apply(this.context, arguments)
                        }
                            .bind(this), function() {
                            t.deferred.reject.apply(this.context, arguments)
                        }
                            .bind(this)) : (t.deferred.resolve.apply(this.context, i),
                            t.promise) : t.promise ? t.promise : void 0
                    }
                    dump() {
                        for (; this._q.length; )
                            this.dequeue()
                        ...
                        return this.running || (this.running = !0,
                            ...
                            this.tick.call(window, () => {
                                    this._q.length ? this.dequeue().then(function() {
                                        ...
                                        .bind(this)) : (this.defered.resolve(),
                                        this.running = void 0)
                                }
                            ),
            ...
            , function(t, e, i) {
                ...
                function o() {
                    ...
                    return document.body.appendChild(e),
                        e.scrollLeft > 0 ? t = "default" : "undefined" != typeof Element && Element.prototype.scrollIntoView ? (e.children[0].children[1].scrollIntoView(),
                        e.scrollLeft < 0 && (t = "negative")) : (e.scrollLeft = 1,
                ...
                var u = class {
                        ...
                        create(t) {
                            ...
                            "horizontal" === s && (a.style.display = "flex",
                                a.style.flexDirection = "row",
                                a.style.flexWrap = "nowrap"),
                            i && (a.style.width = i),
                            e && (a.style.height = e),
                            n && ("scroll" === n && "vertical" === s ? (a.style["overflow-y"] = n,
                                a.style["overflow-x"] = "hidden") : "scroll" === n && "horizontal" === s ? (a.style["overflow-y"] = "hidden",
                                a.style["overflow-x"] = n) : a.style.overflow = n),
                            o && (a.dir = o,
                                a.style.direction = o),
                        ...
                        getElement(t) {
                            var e;
                            if (Object(r.isElement)(t) ? e = t : "string" == typeof t && (e = document.getElementById(t)),
                                !e)
                        ...
                        attachTo(t) {
                            ...
                            if (i)
                                return e = this.settings.hidden ? this.wrapper : this.container,
                                    i.appendChild(e),
                                    this.element = i,
                                    i
                        }
                        ...
                        onResize(t) {
                            Object(r.isNumber)(this.settings.width) && Object(r.isNumber)(this.settings.height) || (this.resizeFunc = c()(t, 50),
                        ...
                        size(t, e) {
                            ...
                            null === t ? (i = this.element.getBoundingClientRect()).width && (t = Math.floor(i.width),
                                this.container.style.width = t + "px") : Object(r.isNumber)(t) ? this.container.style.width = t + "px" : this.container.style.width = t,
                                null === e ? (i = i || this.element.getBoundingClientRect()).height && (e = i.height,
                                    this.container.style.height = e + "px") : Object(r.isNumber)(e) ? this.container.style.height = e + "px" : this.container.style.height = e,
                        ...
                        bounds() {
                            let t;
                            return "visible" !== this.container.style.overflow && (t = this.container && this.container.getBoundingClientRect()),
                                t && t.width && t.height ? t : Object(r.windowBounds)()
                        }
                        getSheet() {
                            var t = document.createElement("style");
                            return t.appendChild(document.createTextNode("")),
                        ...
                        axis(t) {
                            "horizontal" === t ? (this.container.style.display = "flex",
                                this.container.style.flexDirection = "row",
                                this.container.style.flexWrap = "nowrap") : this.container.style.display = "block",
                                this.settings.axis = t
                        }
                        direction(t) {
                            this.container && (this.container.dir = t,
                                this.container.style.direction = t),
                            this.settings.fullsize && (document.body.style.direction = t),
                                this.settings.dir = t
                        }
                        overflow(t) {
                            this.container && ("scroll" === t && "vertical" === this.settings.axis ? (this.container.style["overflow-y"] = t,
                                this.container.style["overflow-x"] = "hidden") : "scroll" === t && "horizontal" === this.settings.axis ? (this.container.style["overflow-y"] = "hidden",
                                this.container.style["overflow-x"] = t) : this.container.style.overflow = t),
                                this.settings.overflow = t
                        }
                        destroy() {
                            this.element && (this.settings.hidden ? this.wrapper : this.container,
                ...
                var d = class {
                    ...
                    append(t) {
                        return this._views.push(t),
                        this.container && this.container.appendChild(t.element),
                            this.length++,
                            t
                    }
                    prepend(t) {
                        return this._views.unshift(t),
                        this.container && this.container.insertBefore(t.element, this.container.firstChild),
                            this.length++,
                            t
                    }
                    insert(t, e) {
                        return this._views.splice(e, 0, t),
                        this.container && (e < this.container.children.length ? this.container.insertBefore(t.element, this.container.children[e]) : this.container.appendChild(t.element)),
                            this.length++,
                            t
                    }
                    remove(t) {
                ...
                class p {
                    ...
                    render(t, e) {
                        let i = t.tagName;
                        void 0 !== this.settings.fullsize || !i || "body" != i.toLowerCase() && "html" != i.toLowerCase() || (this.settings.fullsize = !0),
                        this.settings.fullsize && (this.settings.overflow = "visible",
                    ...
                    resize(t, e, i) {
                        ...
                        this.winBounds = Object(r.windowBounds)(),
                            this.orientationTimeout && this.winBounds.width === this.winBounds.height ? this._stageSize = void 0 : this._stageSize && this._stageSize.width === n.width && this._stageSize.height === n.height || (this._stageSize = n,
                                this._bounds = this.bounds(),
                                this.clear(),
                                this.viewSettings.width = this._stageSize.width,
                                this.viewSettings.height = this._stageSize.height,
                                this.updateLayout(),
                                this.emit(f.c.MANAGERS.RESIZED, {
                    ...
                    display(t, e) {
                        ...
                        this.clear();
                        let o = !1;
                        return "pre-paginated" === this.layout.name && 2 === this.layout.divisor && t.properties.includes("page-spread-right") && (o = !0),
                            this.add(t, o).then(function(t) {
                                    if (e) {
                    ...
                    moveTo(t, e) {
                        var i = 0
                            , n = 0;
                        this.isPaginated ? ((i = Math.floor(t.left / this.layout.delta) * this.layout.delta) + this.layout.delta > this.container.scrollWidth && (i = this.container.scrollWidth - this.layout.delta),
                        (n = Math.floor(t.top / this.layout.delta) * this.layout.delta) + this.layout.delta > this.container.scrollHeight && (n = this.container.scrollHeight - this.layout.delta)) : n = t.top,
                        "rtl" === this.settings.direction && (i += this.layout.delta,
                            i -= e),
                            this.scrollTo(i, n, !0)
                    }
                    add(t, e) {
                        var i = this.createView(t, e);
                        return this.views.append(i),
                            ...
                            if (!this.isPaginated || "horizontal" !== this.settings.axis || e && "ltr" !== e)
                                if (this.isPaginated && "horizontal" === this.settings.axis && "rtl" === e)
                                    this.scrollLeft = this.container.scrollLeft,
                                        "default" === this.settings.rtlScrollType ? this.container.scrollLeft > 0 ? this.scrollBy(this.layout.delta, 0, !0) : t = this.views.last().section.next() : this.container.scrollLeft + -1 * this.layout.delta > -1 * this.container.scrollWidth ? this.scrollBy(this.layout.delta, 0, !0) : t = this.views.last().section.next();
                                else if (this.isPaginated && "vertical" === this.settings.axis) {
                                    this.scrollTop = this.container.scrollTop,
                                        this.container.scrollTop + this.container.offsetHeight < this.container.scrollHeight ? this.scrollBy(0, this.layout.height, !0) : t = this.views.last().section.next()
                                } else
                                    t = this.views.last().section.next();
                            else
                                this.scrollLeft = this.container.scrollLeft,
                                    this.container.scrollLeft + this.container.offsetWidth + this.layout.delta <= this.container.scrollWidth ? this.scrollBy(this.layout.delta, 0, !0) : t = this.views.last().section.next();
                            if (t) {
                                this.clear(),
                                    this.updateLayout();
                                let e = !1;
                                return "pre-paginated" === this.layout.name && 2 === this.layout.divisor && t.properties.includes("page-spread-right") && (e = !0),
                                    this.append(t, e).then(function() {
                                        return this.handleNextPrePaginated(e, t, this.append)
                                    }
                                        .bind(this), t => t).then(function() {
                                        this.isPaginated || "horizontal" !== this.settings.axis || "rtl" !== this.settings.direction || "default" !== this.settings.rtlScrollType || this.scrollTo(this.container.scrollWidth, 0, !0),
                                            this.views.show()
                                    }
                                        .bind(this))
                            }
                    ...
                    prev() {
                        ...
                        if (this.views.length) {
                            if (!this.isPaginated || "horizontal" !== this.settings.axis || e && "ltr" !== e)
                                if (this.isPaginated && "horizontal" === this.settings.axis && "rtl" === e)
                                    this.scrollLeft = this.container.scrollLeft,
                                        "default" === this.settings.rtlScrollType ? this.container.scrollLeft + this.container.offsetWidth < this.container.scrollWidth ? this.scrollBy(-this.layout.delta, 0, !0) : t = this.views.first().section.prev() : this.container.scrollLeft < 0 ? this.scrollBy(-this.layout.delta, 0, !0) : t = this.views.first().section.prev();
                                else if (this.isPaginated && "vertical" === this.settings.axis) {
                                    this.scrollTop = this.container.scrollTop,
                                        this.container.scrollTop > 0 ? this.scrollBy(0, -this.layout.height, !0) : t = this.views.first().section.prev()
                                } else
                                    t = this.views.first().section.prev();
                            else
                                this.scrollLeft = this.container.scrollLeft,
                                    this.container.scrollLeft > 0 ? this.scrollBy(-this.layout.delta, 0, !0) : t = this.views.first().section.prev();
                            if (t) {
                                this.clear(),
                                    this.updateLayout();
                                let e = !1;
                                return "pre-paginated" === this.layout.name && 2 === this.layout.divisor && "object" != typeof t.prev() && (e = !0),
                                    this.prepend(t, e).then(function() {
                                        var e;
                                        if ("pre-paginated" === this.layout.name && this.layout.divisor > 1 && (e = t.prev()))
                                            return this.prepend(e)
                                    }
                                        .bind(this), t => t).then(function() {
                                        this.isPaginated && "horizontal" === this.settings.axis && ("rtl" === this.settings.direction ? "default" === this.settings.rtlScrollType ? this.scrollTo(0, 0, !0) : this.scrollTo(-1 * this.container.scrollWidth + this.layout.delta, 0, !0) : this.scrollTo(this.container.scrollWidth - this.layout.delta, 0, !0)),
                                            this.views.show()
                                    }
                                        .bind(this))
                            }
                    ...
                    clear() {
                        this.views && (this.views.hide(),
                            this.scrollTo(0, 0, !0),
                            this.views.clear())
                    }
                    currentLocation() {
                        return this.updateLayout(),
                            this.isPaginated && "horizontal" === this.settings.axis ? this.location = this.paginatedLocation() : this.location = this.scrolledLocation(),
                            this.location
                    }
                    scrolledLocation() {
                        let t = this.visible()
                            ...
                            , r = (this.settings.direction,
                            0);
                        return this.settings.fullsize && (r = s ? window.scrollY : window.scrollX),
                            t.map(t => {
                                    let o, a, h, l, {index: c, href: u} = t.section, d = t.position(), f = t.width(), p = t.height();
                                    s ? (o = r + e.top - d.top + 0,
                                        a = o + i - 0,
                                        l = this.layout.count(p, i).pages,
                                        h = i) : (o = r + e.left - d.left + 0,
                                        a = o + n - 0,
                    ...
                    paginatedLocation() {
                        let t = this.visible()
                            ...
                            , i = 0
                            , n = 0;
                        return this.settings.fullsize && (i = window.scrollX),
                            t.map(t => {
                                    let s, r, o, a, {index: h, href: l} = t.section, c = t.position(), u = t.width();
                                    "rtl" === this.settings.direction ? (s = e.right - i,
                    ...
                    scrollBy(t, e, i) {
                        ...
                        i && (this.ignore = !0),
                            this.settings.fullsize ? window.scrollBy(t * n, e * n) : (t && (this.container.scrollLeft += t * n),
                            e && (this.container.scrollTop += e)),
                            this.scrolled = !0
                    }
                    scrollTo(t, e, i) {
                        i && (this.ignore = !0),
                            this.settings.fullsize ? window.scrollTo(t, e) : (this.container.scrollLeft = t,
                                this.container.scrollTop = e),
                            this.scrolled = !0
                    }
                    onScroll() {
                        let t, e;
                        this.settings.fullsize ? (t = window.scrollY,
                            e = window.scrollX) : (t = this.container.scrollTop,
                            e = this.container.scrollLeft),
                            this.scrollTop = t,
                            this.scrollLeft = e,
                            this.ignore ? this.ignore = !1 : (this.emit(f.c.MANAGERS.SCROLL, {
                                top: t,
                                left: e
                            }),
                                clearTimeout(this.afterScrolled),
                    ...
                    applyLayout(t) {
                        this.layout = t,
                            this.updateLayout(),
                        this.views && this.views.length > 0 && "pre-paginated" === this.layout.name && this.display(this.views.first().section)
                    }
                    updateLayout() {
                        this.stage && (this._stageSize = this.stage.size(),
                            this.isPaginated ? (this.layout.calculate(this._stageSize.width, this._stageSize.height, this.settings.gap),
                                this.settings.offset = this.layout.delta / this.layout.divisor) : this.layout.calculate(this._stageSize.width, this._stageSize.height),
                    ...
                    setLayout(t) {
                        ...
                        this.views && this.views.forEach((function(e) {
                                e && e.setLayout(t)
                            }
                        ))
                    }
                    ...
                    updateAxis(t, e) {
                        (e || t !== this.settings.axis) && (this.settings.axis = t,
                        ...
                        this.layout && ("vertical" === t ? this.layout.spread("none") : this.layout.spread(this.layout.settings.spread)))
                    }
                    updateFlow(t, e="auto") {
                        let i = "paginated" === t || "auto" === t;
                        this.isPaginated = i,
                            "scrolled-doc" === t || "scrolled-continuous" === t || "scrolled" === t ? this.updateAxis("vertical") : this.updateAxis("horizontal"),
                ...
                e.a = class {
                    ...
                    walk(t, e) {
                        if (!t || t.nodeType !== Node.TEXT_NODE) {
                            var i = function(t) {
                                ...
                                , n = i;
                            n.acceptNode = i;
                            for (var s, r, o = document.createTreeWalker(t, NodeFilter.SHOW_TEXT, n, !1); (s = o.nextNode()) && !(r = e(s)); )
                                ;
                            return r
                        }
                    }
                    findRanges(t) {
                        for (var e, i, n = [], s = t.contents.scrollWidth(), r = Math.ceil(s / this.layout.spreadWidth) * this.layout.divisor, o = this.layout.columnWidth, a = this.layout.gap, h = 0; h < r.pages; h++)
                            e = (o + a) * h,
                                i = o * (h + 1) + a * h,
                                n.push({
                    ...
                    findStart(t, e, i) {
                        for (var n, r, o = [t], a = t; o.length; )
                            if (n = o.shift(),
                                r = this.walk(n, t => {
                                        var n, r, h, l, c;
                                        if (c = Object(s.nodeBounds)(t),
                                        this.horizontal && "ltr" === this.direction) {
                                            if (n = this.horizontal ? c.left : c.top,
                            ...
                            if (n = o.shift(),
                                r = this.walk(n, t => {
                                        ...
                                        this.horizontal && "ltr" === this.direction) {
                                            ...
                                            if (n = Math.round(this.horizontal ? c.left : c.top),
                    ...
                    findTextStartRange(t, e, i) {
                        for (var n, s, r = this.splitTextNodeIntoRanges(t), o = 0; o < r.length; o++)
                            if (s = (n = r[o]).getBoundingClientRect(),
                            this.horizontal && "ltr" === this.direction) {
                                if (s.left >= e)
                                    return n
                            } else if (this.horizontal && "rtl" === this.direction) {
                    ...
                    findTextEndRange(t, e, i) {
                        for (var n, s, r, o, a, h, l, c = this.splitTextNodeIntoRanges(t), u = 0; u < c.length; u++) {
                            if (r = (s = c[u]).getBoundingClientRect(),
                            this.horizontal && "ltr" === this.direction) {
                                if (o = r.left,
                                    a = r.right,
                                o > i && n)
                    ...
                    splitTextNodeIntoRanges(t, e) {
                        var i, n = [], s = (t.textContent || "").trim(), r = t.ownerDocument, o = e || " ", a = s.indexOf(o);
                        if (-1 === a || t.nodeType != Node.TEXT_NODE)
                            return (i = r.createRange()).selectNodeContents(t),
                                [i];
                        for ((i = r.createRange()).setStart(t, 0),
                                 i.setEnd(t, a),
                                 n.push(i),
                                 i = !1; -1 != a; )
                            (a = s.indexOf(o, a + 1)) > 0 && (i && (i.setEnd(t, a),
                                n.push(i)),
                                (i = r.createRange()).setStart(t, a + 1));
                        return i && (i.setEnd(t, s.length),
                            n.push(i)),
                            n
                    }
                    ...
                    rangeListToCfiList(t, e) {
                        for (var i, n = [], s = 0; s < e.length; s++)
                            i = this.rangePairToCfiPair(t, e[s]),
                                n.push(i);
                        return n
                    }
                    axis(t) {
                        return t && (this.horizontal = "horizontal" === t),
                            this.horizontal
                    }
                }
            }
            , function(t, e, i) {
                ...
                class f {
                    ...
                    width(t) {
                        var e = this.content;
                        return t && Object(r.isNumber)(t) && (t += "px"),
                        t && (e.style.width = t),
                    ...
                    textWidth() {
                        let t, e, i = this.document.createRange(), n = this.content || this.document.body, s = Object(r.borders)(n);
                    ...
                    overflow(t) {
                        return t && (this.documentElement.style.overflow = t),
                            this.window.getComputedStyle(this.documentElement).overflow
                    }
                    overflowX(t) {
                        return t && (this.documentElement.style.overflowX = t),
                            this.window.getComputedStyle(this.documentElement).overflowX
                    }
                    overflowY(t) {
                        return t && (this.documentElement.style.overflowY = t),
                            this.window.getComputedStyle(this.documentElement).overflowY
                    }
                    css(t, e, i) {
                        var n = this.content || this.document.body;
                        return e ? n.style.setProperty(t, e, i ? "important" : "") : n.style.removeProperty(t),
                            this.window.getComputedStyle(n)[t]
                    }
                    viewport(t) {
                        var e, i = this.document.querySelector("meta[name='viewport']"), n = {
                            width: void 0,
                            height: void 0,
                            scale: void 0,
                            minimum: void 0,
                        ...
                        return e = Object(r.defaults)(t || {}, n),
                        t && (e.width && s.push("width=" + e.width),
                        ...
                        e.scale && s.push("initial-scale=" + e.scale),
                            "no" === e.scalable ? (s.push("minimum-scale=" + e.scale),
                                ...
                                s.push("user-scalable=" + e.scalable)) : (e.scalable && s.push("user-scalable=" + e.scalable),
                            e.minimum && s.push("minimum-scale=" + e.minimum),
                            e.maximum && s.push("minimum-scale=" + e.maximum)),
                        i || ((i = this.document.createElement("meta")).setAttribute("name", "viewport"),
                    ...
                    listeners() {
                        this.imageLoadListeners(),
                            ...
                            "undefined" == typeof ResizeObserver ? (this.resizeListeners(),
                                this.visibilityListeners()) : this.resizeObservers(),
                            this.linksHandler()
                    }
                    removeListeners() {
                        this.removeEventListeners(),
                    ...
                    visibilityListeners() {
                        document.addEventListener("visibilitychange", () => {
                                "visible" === document.visibilityState && !1 === this.active ? (this.active = !0,
                                    this.resizeListeners()) : (this.active = !1,
                                    clearTimeout(this.expanding))
                            }
                        )
                    }
                    transitionListeners() {
                        let t = this.content;
                        t.style.transitionProperty = "font, font-size, font-size-adjust, font-stretch, font-variation-settings, font-weight, width, height",
                            ...
                            if (s) {
                                ...
                                if (s.startContainer.nodeType === Node.ELEMENT_NODE)
                                    ...
                                    let t = s.startContainer
                                        , e = new Range;
                                    try {
                                        1 === t.nodeType ? i = t.getBoundingClientRect() : s.startOffset + 2 < t.length ? (e.setStart(t, s.startOffset),
                                            e.setEnd(t, s.startOffset + 2),
                                            i = e.getBoundingClientRect()) : s.startOffset - 2 > 0 ? (e.setStart(t, s.startOffset - 2),
                                            e.setEnd(t, s.startOffset),
                                            i = e.getBoundingClientRect()) : i = t.parentNode.getBoundingClientRect()
                                    } catch (t) {
                    ...
                    addStylesheet(t) {
                        return new Promise(function(e, i) {
                            var n, s = !1;
                            this.document ? (n = this.document.querySelector("link[href='" + t + "']")) ? e(!0) : ((n = this.document.createElement("link")).type = "text/css",
                                n.rel = "stylesheet",
                                n.href = t,
                    ...
                    _getStylesheetNode(t) {
                        var e;
                        return t = "epubjs-inserted-css-" + (t || ""),
                        !!this.document && ((e = this.document.getElementById(t)) || ((e = this.document.createElement("style")).id = t,
                            this.document.head.appendChild(e)),
                            e)
                    }
                    addStylesheetCss(t, e) {
                        return !(!this.document || !t) && (this._getStylesheetNode(e).innerHTML = t,
                            !0)
                    }
                    addStylesheetRules(t, e) {
                        var i;
                        if (this.document && t && 0 !== t.length)
                            if (i = this._getStylesheetNode(e).sheet,
                            "[object Array]" === Object.prototype.toString.call(t))
                                for (var n = 0, s = t.length; n < s; n++) {
                                    var r = 1
                                        ...
                                        , a = t[n][0]
                                        , h = "";
                                    "[object Array]" === Object.prototype.toString.call(o[1][0]) && (o = o[1],
                                        r = 0);
                    ...
                    addScript(t) {
                        return new Promise(function(e, i) {
                            var n, s = !1;
                            this.document ? ((n = this.document.createElement("script")).type = "text/javascript",
                                n.async = !0,
                                n.src = t,
                                n.onload = n.onreadystatechange = function() {
                                    s || this.readyState && "complete" != this.readyState || (s = !0,
                    ...
                    triggerEvent(t) {
                        ...
                        //if (isWeChat && isAndroid) {
                            if(t.type == 'mousedown' || t.type == 'touchstart') {
                                touchStart = t.screenX || t.changedTouches[0].screenX;
                            };
                            if(t.type == 'mouseup'  || t.type == 'touchend') {
                                touchEnd = t.screenX || t.changedTouches[0].screenX;
                    ...
                    addSelectionListeners() {
                        this.document && (this._onSelectionChange = this.onSelectionChange.bind(this),
                    ...
                    triggerSelectedEvent(t) {
                        var e, i;
                        t && t.rangeCount > 0 && ((e = t.getRangeAt(0)).collapsed || (i = new o.a(e,this.cfiBase).toString(),
                    ...
                    columns(t, e, i, n, s) {
                        ...
                        "rtl" === s && "horizontal" === c && this.direction(s),
                            ...
                            this.css("margin", "0", !0),
                            "vertical" === c ? (this.css("padding-top", n / 2 + "px", !0),
                                this.css("padding-bottom", n / 2 + "px", !0),
                                this.css("padding-left", "20px"),
                                this.css("padding-right", "20px"),
                                this.css(o, "vertical")) : (this.css("padding-top", "20px"),
                    ...
                    writingMode(t) {
                        ...
                        return t && this.documentElement && (this.documentElement.style[e] = t),
                        this.window.getComputedStyle(this.documentElement)[e] || ""
                    }
                    layoutStyle(t) {
                        return t && (this._layoutStyle = t,
                        ...
                        n(e, [{
                            ...
                            value: function(t, i) {
                                ...
                                for (var n in this.attributes)
                                    this.attributes.hasOwnProperty(n) && this.element.setAttribute(n, this.attributes[n]);
            ...
            , function(t, e, i) {
                ...
                class c {
                    constructor(t) {
                        this.settings = t,
                            ...
                            "scrolled" === t.flow || "scrolled-continuous" === t.flow || "scrolled-doc" === t.flow ? this._flow = "scrolled" : this._flow = "paginated",
                            this.width = 0,
                            this.height = 0,
                            this.spreadWidth = 0,
                            this.delta = 0,
                    ...
                    flow(t) {
                        return void 0 !== t && (this._flow = "scrolled" === t || "scrolled-continuous" === t || "scrolled-doc" === t ? "scrolled" : "paginated",
                            this.update({
                                flow: this._flow
                            })),
                            this._flow
                    ...
                    calculate(t, e, i) {
                        var n, s, r, o, a = 1, h = i || 0, l = t, c = e, u = Math.floor(l / 12);
                    ...
                    count(t, e) {
                        let i, n;
                        return "pre-paginated" === this.name ? (i = 1,
                            n = 1) : "paginated" === this._flow ? (e = e || this.delta,
                            i = Math.ceil(t / e),
                            n = i * this.divisor) : (e = e || this.height,
                            i = Math.ceil(t / e),
                            n = i),
                            {
                                spreads: i,
                ...
                var f = class {
                        ...
                        register() {
                            if (0 !== arguments.length)
                                return 1 === arguments.length && "object" == typeof arguments[0] ? this.registerThemes(arguments[0]) : 1 === arguments.length && "string" == typeof arguments[0] ? this.default(arguments[0]) : 2 === arguments.length && "string" == typeof arguments[1] ? this.registerUrl(arguments[0], arguments[1]) : 2 === arguments.length && "object" == typeof arguments[1] ? this.registerRules(arguments[0], arguments[1]) : void 0
                        }
                        default(t) {
                            if (t)
                                return "string" == typeof t ? this.registerUrl("default", t) : "object" == typeof t ? this.registerRules("default", t) : void 0
                        }
                        registerThemes(t) {
                            for (var e in t)
                                t.hasOwnProperty(e) && ("string" == typeof t[e] ? this.registerUrl(e, t[e]) : this.registerRules(e, t[e]))
                        }
                        registerCss(t, e) {
                            this._themes[t] = {
                                serialized: e
                        ...
                        inject(t) {
                            var e, i = [], n = this._themes;
                            for (var s in n)
                                !n.hasOwnProperty(s) || s !== this._current && "default" !== s || (((e = n[s]).rules && Object.keys(e.rules).length > 0 || e.url && -1 === i.indexOf(e.url)) && this.add(s, t),
                                    this._injected.push(s));
                            "default" != this._current && t.addClass(this._current)
                        }
                        add(t, e) {
                            var i = this._themes[t];
                            i && e && (i.url ? e.addStylesheet(i.url) : i.serialized ? (e.addStylesheetCss(i.serialized, t),
                                i.injected = !0) : i.rules && (e.addStylesheetRules(i.rules, t),
                                i.injected = !0))
                        }
                        override(t, e, i) {
                ...
                class p {
                    ...
                    attach(t) {
                        let e, {cfiRange: i, data: n, type: s, mark: r, cb: o, className: a, styles: h} = this;
                        return "highlight" === s ? e = t.highlight(i, n, o, a, h) : "underline" === s ? e = t.underline(i, n, o, a, h) : "mark" === s && (e = t.mark(i, n, o)),
                            this.mark = e,
                            this.emit(l.c.ANNOTATION.ATTACH, e),
                            e
                    }
                    detach(t) {
                        let e, {cfiRange: i, type: n} = this;
                        return t && ("highlight" === n ? e = t.unhighlight(i) : "underline" === n ? e = t.ununderline(i) : "mark" === n && (e = t.unmark(i))),
                            this.mark = void 0,
                ...
                var g = class {
                    ...
                    add(t, e, i, n, s, r) {
                        ...
                        return this._annotations[o] = l,
                            h in this._annotationsBySectionIndex ? this._annotationsBySectionIndex[h].push(o) : this._annotationsBySectionIndex[h] = [o],
                ...
                class b {
                    ...
                    start() {
                        switch (this.settings.layout || "pre-paginated" !== this.book.package.metadata.layout && "true" !== this.book.displayOptions.fixedLayout || (this.settings.layout = "pre-paginated"),
                        ...
                        this.manager || (this.ViewManager = this.requireManager(this.settings.manager),
                    ...
                    display(t) {
                        return this.displaying && this.displaying.resolve(),
                            this.q.enqueue(this._display, t)
                    }
                    _display(t) {
                        if (this.book) {
                            this.epubcfi.isCfiString(t);
                            var e, i = new r.defer, n = i.promise;
                            return this.displaying = i,
                            this.book.locations.length() && Object(r.isFloat)(t) && (t = this.book.locations.cfiFromPercentage(parseFloat(t))),
                                (e = this.book.spine.get(t)) ? (this.manager.display(e, t).then( () => {
                                        i.resolve(e),
                                    ...
                                    n) : (i.reject(new Error("No Section Found")),
                                    n)
                        }
                    }
                    afterDisplayed(t) {
                    ...
                    flow(t) {
                        ...
                        this.manager && this.manager.isRendered() && this.location && (this.manager.clear(),
                            this.display(this.location.start.cfi))
                    }
                    layout(t) {
                        return t && (this._layout = new u(t),
                    ...
                    located(t) {
                        ...
                        return -1 != o && (n.start.page = o),
                        -1 != a && (n.end.page = a),
                        i.index === this.book.spine.last().index && n.end.displayed.page >= n.end.displayed.total && (n.atEnd = !0),
                    ...
                    getRange(t, e) {
                        var i = new a.a(t)
                            , n = this.manager.visible().filter((function(t) {
                                if (i.spinePos === t.index)
                                    return !0
                            }
                        ));
                        if (n.length)
                            return n[0].contents.range(i, e)
                    }
                    adjustImages(t) {
            ...
            , function(t, e, i) {
                ...
                class c {
                    ...
                    container(t) {
                        var e = document.createElement("div");
                        return e.classList.add("epub-view"),
                            e.style.height = "0px",
                            e.style.width = "0px",
                            e.style.overflow = "hidden",
                    ...
                    create() {
                        return this.iframe || (this.element || (this.element = this.createContainer()),
                        ...
                        this.settings.allowPopups && (this.iframe.sandbox += " allow-popups"),
                            ...
                            "srcdoc"in this.iframe && !(/micromessenger/.test(window.navigator.userAgent.toLowerCase())) ? this.supportsSrcdoc = !0 : this.supportsSrcdoc = !1,
                    ...
                    render(t, e) {
                        ...
                        this.sectionRender || (this.sectionRender = this.section.render(t)),
                            this.sectionRender.then(function(t) {
                                return this.load(t)
                            }
                                .bind(this)).then(function() {
                                let t, e = this.contents.writingMode();
                                return t = "scrolled" === this.settings.flow ? 0 === e.indexOf("vertical") ? "horizontal" : "vertical" : 0 === e.indexOf("vertical") ? "vertical" : "horizontal",
                                0 === e.indexOf("vertical") && "paginated" === this.settings.flow && (this.layout.delta = this.layout.height),
                                    this.setAxis(t),
                                ...
                                return this.emit(h.c.VIEWS.LOAD_ERROR, t),
                                    new Promise( (e, i) => {
                                            i(t)
                                        }
                                    )
                    ...
                    reset() {
                        this.iframe && (this.iframe.style.width = "0",
                            this.iframe.style.height = "0",
                            this._width = 0,
                            this._height = 0,
                    ...
                    size(t, e) {
                        ...
                        "pre-paginated" === this.layout.name ? this.lock("both", i, n) : "horizontal" === this.settings.axis ? this.lock("height", i, n) : this.lock("width", i, n),
                    ...
                    lock(t, e, i) {
                        ...
                        "both" === t && Object(r.isNumber)(e) && Object(r.isNumber)(i) && (this.lockedWidth = e - s.width - n.width,
                            this.lockedHeight = i - s.height - n.height),
                        this.displayed && this.iframe && this.expand()
                    }
                    expand(t) {
                        var e, i = this.lockedWidth, n = this.lockedHeight;
                        this.iframe && !this._expanding && (this._expanding = !0,
                            "pre-paginated" === this.layout.name ? (i = this.layout.columnWidth,
                                n = this.layout.height) : "horizontal" === this.settings.axis ? ((i = this.contents.textWidth()) % this.layout.pageWidth > 0 && (i = Math.ceil(i / this.layout.pageWidth) * this.layout.pageWidth),
                            this.settings.forceEvenPages && (e = i / this.layout.pageWidth,
                            this.layout.divisor > 1 && "reflowable" === this.layout.name && e % 2 > 0 && (i += this.layout.pageWidth))) : "vertical" === this.settings.axis && (n = this.contents.textHeight(),
                            "paginated" === this.settings.flow && n % this.layout.height > 0 && (n = Math.ceil(n / this.layout.height) * this.layout.height)),
                        (this._needsReframe || i != this._width || n != this._height) && this.reframe(i, n),
                            this._expanding = !1)
                    }
                    reframe(t, e) {
                        var i;
                        Object(r.isNumber)(t) && (this.element.style.width = t + "px",
                            this.iframe.style.width = t + "px",
                            this._width = t),
                        Object(r.isNumber)(e) && (this.element.style.height = e + "px",
                        ...
                        this.pane && this.pane.render(),
                            requestAnimationFrame( () => {
                                    ...
                                    for (let e in this.marks)
                                        this.marks.hasOwnProperty(e) && (t = this.marks[e],
                    ...
                    load(t) {
                        var e = new r.defer
                            , i = e.promise;
                        if (!this.iframe)
                            return e.reject(new Error("No Iframe Available")),
                                i;
                        ...
                        "blobUrl" === this.settings.method)
                            ...
                            if (this.element.appendChild(this.iframe),
                                this.document = this.iframe.contentDocument,
                                !this.document)
                                return e.reject(new Error("No Document Available")),
                                    i;
                            if (this.iframe.contentDocument.open(),
                    ...
                    onLoad(t, e) {
                        ...
                        i ? i.setAttribute("href", this.section.canonical) : ((i = this.document.createElement("link")).setAttribute("rel", "canonical"),
                    ...
                    onResize(t, e) {}
                    bounds(t) {
                        return !t && this.elementBounds || (this.elementBounds = Object(r.bounds)(this.element)),
                            this.elementBounds
                    }
                    ...
                    mark(t, e={}, i) {
                        ...
                        ;
                        n.collapsed && 1 === s.nodeType ? (n = new Range,
                            n.selectNodeContents(s)) : n.collapsed && (n = new Range,
                            n.selectNodeContents(r));
                        let a = this.document.createElement("a");
                        return a.setAttribute("ref", "epubjs-mk"),
                    ...
                    placeMark(t, e) {
                        ...
                        if ("pre-paginated" === this.layout.name || "horizontal" !== this.settings.axis) {
                            ...
                            for (var r = 0; r != o.length; r++)
                                t = o[r],
                                (!s || t.left < s) && (s = t.left,
                                    n = Math.ceil(s / this.layout.props.pageWidth) * this.layout.props.pageWidth - this.layout.gap / 2,
                                    i = t.top)
                        }
                        t.style.top = i + "px",
                            t.style.left = n + "px"
                    ...
                    unhighlight(t) {
                        let e;
                        t in this.highlights && (e = this.highlights[t],
                            this.pane.removeMark(e.mark),
                            e.listeners.forEach(t => {
                                    t && (e.element.removeEventListener("click", t),
                    ...
                    ununderline(t) {
                        let e;
                        t in this.underlines && (e = this.underlines[t],
                            this.pane.removeMark(e.mark),
                            e.listeners.forEach(t => {
                                    t && (e.element.removeEventListener("click", t),
                                        e.element.removeEventListener("touchstart", t))
                    ...
                    unmark(t) {
                        let e;
                        t in this.marks && (e = this.marks[t],
                    ...
                    destroy() {
                        for (let t in this.highlights)
                            this.unhighlight(t);
                        for (let t in this.underlines)
                            this.ununderline(t);
                        ...
                        this.pane && (this.pane.element.remove(),
                            this.pane = void 0),
                            this.iframe = void 0,
            ...
            , function(t, e, i) {
                ...
                t.exports = function(t, e, i) {
                    var h, l, c, u, d, f, p = 0, g = !1, m = !1, v = !0;
                ...
                class c {
                    ...
                    setup(t) {
                        this.manager = t,
                            ...
                            this.fullsize ? (this.element = this.manager.stage.element,
                                this.scroller = window,
                                this.disableScroll()) : (this.element = this.manager.stage.container,
                        ...
                        this.manager.isPaginated && !this.isVertical && (this.touchCanceler = !1,
                    ...
                    onTouchStart(t) {
                        ...
                        this.startTouchX || (this.startTouchX = e,
                            this.startTouchY = i,
                        ...
                        return this.snapping = !0,
                            function n() {
                                ...
                                this.touchCanceler || this.resizeCanceler)
                                    return this.resizeCanceler = !1,
                                        this.snapping = !1,
                                        void e.resolve();
                                h < 1 ? (window.requestAnimationFrame(n.bind(this)),
                                    this.scrollTo(i + (t - i) * h, 0)) : (this.scrollTo(t, 0),
                                    this.snapping = !1,
                                    e.resolve())
                            }
                                .call(this),
                    ...
                    scrollTo(t=0, e=0) {
                        this.fullsize ? window.scroll(t, e) : (this.scroller.scrollLeft = t,
                    ...
                    destroy() {
                        this.scroller && (this.fullsize && this.enableScroll(),
                            this.removeListeners(),
                ...
                class p extends s.a {
                    ...
                    moveTo(t) {
                        ...
                        this.isPaginated ? (e = Math.floor(t.left / this.layout.delta) * this.layout.delta,
                            this.settings.offsetDelta) : (i = t.top,
                            t.top,
                    ...
                    check(t, e) {
                        ...
                        this.settings.fullsize ? (r && f && "negative" === d || !r && f && "default" === d) && (h *= -1) : (f && "default" === d && "horizontal" === u && (h = c - l - h),
                    ...
                    trim() {
                        for (var t = new n.defer, e = this.views.displayed(), i = e[0], s = e[e.length - 1], r = this.views.indexOf(i), o = this.views.indexOf(s), a = this.views.slice(0, r), h = this.views.slice(o + 1), l = 0; l < a.length - 1; l++)
                            this.erase(a[l], a);
                    ...
                    erase(t, e) {
                        ...
                        this.settings.fullsize ? (i = window.scrollY,
                            n = window.scrollX) : (i = this.container.scrollTop,
                            n = this.container.scrollLeft);
                        var s = t.bounds();
                        this.views.remove(t),
                        e && ("vertical" === this.settings.axis ? this.scrollTo(0, i - s.height, !0) : "rtl" === this.settings.direction ? this.settings.fullsize ? this.scrollTo(n + Math.floor(s.width), 0, !0) : this.scrollTo(n, 0, !0) : this.scrollTo(n - Math.floor(s.width), 0, !0))
                    }
                    addEventListeners(t) {
                        window.addEventListener("unload", function(t) {
                            this.ignore = !0,
                        ...
                        this.isPaginated && this.settings.snap && (this.snapper = new u(this,this.settings.snap && "object" == typeof this.settings.snap && this.settings.snap))
                    }
                    addScrollListeners() {
                        var t;
                        this.tick = n.requestAnimationFrame;
                        ...
                        this.scrollDeltaVert = 0,
                            ...
                            this.settings.fullsize ? (t = window,
                                this.scrollTop = window.scrollY * e,
                                this.scrollLeft = window.scrollX * e) : (t = this.container,
                                this.scrollTop = this.container.scrollTop,
                                this.scrollLeft = this.container.scrollLeft),
                            this._onScroll = this.onScroll.bind(this),
                            t.addEventListener("scroll", this._onScroll),
                    ...
                    onScroll() {
                        ...
                        this.settings.fullsize ? (t = window.scrollY * i,
                            e = window.scrollX * i) : (t = this.container.scrollTop,
                            e = this.container.scrollLeft),
                            this.scrollTop = t,
                            this.scrollLeft = e,
                    ...
                    next() {
                        ...
                        this.views.length && (this.isPaginated && "horizontal" === this.settings.axis ? this.scrollBy(t, 0, !0) : this.scrollBy(0, this.layout.height, !0),
                            this.q.enqueue(function() {
                                return this.check()
                            }
                                .bind(this)))
                    ...
                    updateFlow(t) {
                        this.rendered && this.snapper && (this.snapper.destroy(),
                            this.snapper = void 0),
                            super.updateFlow(t, "scroll"),
                        this.rendered && this.isPaginated && this.settings.snap && (this.snapper = new u(this,this.settings.snap && "object" == typeof this.settings.snap && this.settings.snap))
                    }
                    destroy() {
                        super.destroy(),
                        this.snapper && this.snapper.destroy()
                    }
                }
                e.a = p
            }
                            ...
                            2: [function(t, e, i) {
                                ...
                                e.exports = l,
                                    ...
                                    l.prototype.then = function(t, e) {
                                        ...
                                        return this.state !== h ? u(i, this.state === a ? t : e, this.outcome) : this.queue.push(new c(i,t,e)),
                                            i
                                    }
                                    ,
                            ...
                            4: [function(t, e, i) {
                                ...
                                function r(t, e) {
                                    ...
                                    try {
                                        ...
                                        if ("TypeError" !== s.name)
                                            throw s;
                                        for (var i = new ("undefined" != typeof BlobBuilder ? BlobBuilder : "undefined" != typeof MSBlobBuilder ? MSBlobBuilder : "undefined" != typeof MozBlobBuilder ? MozBlobBuilder : WebKitBlobBuilder), n = 0; n < t.length; n += 1)
                                            i.append(t[n]);
                                ...
                                function x(t, e) {
                                    ...
                                    if (n && (t.version !== e && console.warn('The database "' + t.name + "\" can't be downgraded from version " + t.db.version + " to version " + t.version + "."),
                                    ...
                                    try {
                                        ...
                                        if (n > 0 && (!t.db || "InvalidStateError" === s.name || "NotFoundError" === s.name))
                                            return o.resolve().then((function() {
                                                    if (!t.db || "NotFoundError" === s.name && !t.db.objectStoreNames.contains(t.storeName) && t.version <= t.db.version)
                                ...
                                var T = {
                                    ...
                                    _initStorage: function(t) {
                                        ...
                                        s || (s = {
                                            ...
                                            d[i.name] = s),
                                            s.forages.push(e),
                                        e._initReady || (e._initReady = e.ready,
                                            e.ready = N);
                                        var r = [];
                                        function a() {
                                            return o.resolve()
                                    ...
                                    setItem: function(t, e, i) {
                                        ...
                                        var s = new o((function(i, s) {
                                                ...
                                                n.ready().then((function() {
                                                        return r = n._dbInfo,
                                                            "[object Blob]" === f.call(e) ? p(r.db).then((function(t) {
                                                                    return t ? e : (i = e,
                                                                        new o((function(t, e) {
                                                                                var n = new FileReader;
                                                                                n.onerror = e,
                                    ...
                                    dropInstance: function(t, e) {
                                        ...
                                        var i = this.config();
                                        (t = "function" != typeof t && t || {}).name || (t.name = t.name || i.name,
                                            ...
                                            n = t.storeName ? l.then((function(e) {
                                                    if (e.objectStoreNames.contains(t.storeName)) {
                                                        ...
                                                        return new o((function(e, n) {
                                                                ...
                                                                throw (v(t, e) || o.resolve()).catch((function() {}
                                                                )),
                                                                    e
                                                            }
                                                        ))
                                ...
                                function A(t) {
                                    var e, i, n, s, r, o = .75 * t.length, a = t.length, h = 0;
                                    "=" === t[t.length - 1] && (o--,
                                    "=" === t[t.length - 2] && o--);
                                ...
                                function L(t) {
                                    var e, i = new Uint8Array(t), n = "";
                                    for (e = 0; e < i.length; e += 3)
                                        n += C[i[e] >> 2],
                                            n += C[(3 & i[e]) << 4 | i[e + 1] >> 4],
                                            n += C[(15 & i[e + 1]) << 2 | i[e + 2] >> 6],
                                            n += C[63 & i[e + 2]];
                                    return i.length % 3 == 2 ? n = n.substring(0, n.length - 1) + "=" : i.length % 3 == 1 && (n = n.substring(0, n.length - 2) + "=="),
                                        n
                                }
                                var j = {
                                    serialize: function(t, e) {
                                        var i = "";
                                        if (t && (i = k.call(t)),
                                        t && ("[object ArrayBuffer]" === i || t.buffer && "[object ArrayBuffer]" === k.call(t.buffer))) {
                                            var n, s = "__lfsc__:";
                                            t instanceof ArrayBuffer ? (n = t,
                                                s += "arbf") : (n = t.buffer,
                                                "[object Int8Array]" === i ? s += "si08" : "[object Uint8Array]" === i ? s += "ui08" : "[object Uint8ClampedArray]" === i ? s += "uic8" : "[object Int16Array]" === i ? s += "si16" : "[object Uint16Array]" === i ? s += "ur16" : "[object Int32Array]" === i ? s += "si32" : "[object Uint32Array]" === i ? s += "ui32" : "[object Float32Array]" === i ? s += "fl32" : "[object Float64Array]" === i ? s += "fl64" : e(new Error("Failed to get type for BinaryArray"))),
                                                e(s + L(n))
                                    ...
                                    deserialize: function(t) {
                                        if ("__lfsc__:" !== t.substring(0, I))
                                            return JSON.parse(t);
                                        var e, i = t.substring(R), n = t.substring(I, R);
                                        if ("blob" === n && O.test(i)) {
                                            var s = i.match(O);
                                            e = s[1],
                                                    ...
                                                    h.serializer.serialize(e, (function(e, l) {
                                                            l ? o(l) : h.db.transaction((function(i) {
                                                                    ...
                                                                    if (e.code === e.QUOTA_ERR) {
                                                                        if (n > 0)
                                                                            return void r(M.apply(s, [t, a, i, n - 1]));
                                                                        o(e)
                                                                    }
                                                                }
                                                            ))
                                ...
                                var B = {
                                                        ...
                                                        s.db.transaction((function(i) {
                                                                P(i, s, "SELECT * FROM " + s.storeName, [], (function(i, n) {
                                                                        for (var r = n.rows, o = r.length, a = 0; a < o; a++) {
                                                                            var h = r.item(a)
                                                                                , l = h.value;
                                                                            if (l && (l = s.serializer.deserialize(l)),
                                                ...
                                                i.ready().then((function() {
                                                        ...
                                                        s.db.transaction((function(i) {
                                                                P(i, s, "SELECT * FROM " + s.storeName + " WHERE key = ? LIMIT 1", [t], (function(t, i) {
                                                                        ...
                                                                        n && (n = s.serializer.deserialize(n)),
                                                                            e(n)
                                                                    }
                                                                ), (function(t, e) {
                                                                        n(e)
                                    ...
                                    dropInstance: function(t, e) {
                                        ...
                                        return a(n = t.name ? new o((function(e) {
                                                var n;
                                                n = t.name === i.name ? s._dbInfo.db : openDatabase(t.name, "", "", 0),
                                                    t.storeName ? e({
                                                        db: n,
                                        ...
                                        )) : o.reject("Invalid arguments"), e),
                                            n
                                    }
                                };
                                function q(t, e) {
                                    var i = t.name + "/";
                                    return t.storeName !== e.storeName && (i += t.storeName + "/"),
                                        i
                                }
                                function F() {
                                    return !function() {
                                ...
                                var U = {
                                    ...
                                    _initStorage: function(t) {
                                        ...
                                        if (t)
                                            for (var i in t)
                                                e[i] = t[i];
                                        return e.keyPrefix = q(t, this._defaultConfig),
                                            F() ? (this._dbInfo = e,
                                                e.serializer = j,
                                                o.resolve()) : o.reject()
                                    },
                                    ...
                                    key: function(t, e) {
                                        var i = this
                                            , n = i.ready().then((function() {
                                                ...
                                                return e && (e = e.substring(n.keyPrefix.length)),
                                                    e
                                            }
                                        ));
                                        return a(n, e),
                                    ...
                                    for (var i, n, s = t.length, r = 0; r < s; ) {
                                        if ((i = t[r]) === (n = e) || "number" == typeof i && "number" == typeof n && isNaN(i) && isNaN(n))
                                            return !0;
                                        r++
                                    }
                                    return !1
                                ...
                                function Q() {
                                    for (var t = 1; t < arguments.length; t++) {
                                        ...
                                        if (e)
                                            for (var i in e)
                                                e.hasOwnProperty(i) && (H(e[i]) ? arguments[0][i] = e[i].slice() : arguments[0][i] = e[i])
                                    }
                                    return arguments[0]
                                }
                                var tt = new (function() {
                                    ...
                                    return t.prototype.config = function(t) {
                                                            ...
                                                            for (var e = function(t) {
                                                                return function() {
                                                                    var e = new Error("Method " + t + " is not implemented by the current driver")
                                                                        , i = o.reject(e);
                                                                    return a(i, arguments[arguments.length - 1]),
                                                                        i
                                                                }
                                                            }, i = 0, n = $.length; i < n; i++) {
                                                                var s = $[i];
                                        ...
                                        t.prototype.setDriver = function(t, e, i) {
                                            ...
                                            return this._driverSet = l.then((function() {
                                                                    ...
                                                                    n._initDriver = function(t) {
                                                                        return function() {
                                                                            ...
                                                                            return function i() {
                                                                                ...
                                                                                return n._driverSet = o.reject(h),
                                                                                    n._driverSet
                                                                            }()
                                                                        }
                                                                    }(s)
                                                    ...
                                                    return n._driverSet = o.reject(t),
                                                        n._driverSet
                                                }
                                            )),
            ...
            , function(t, e, i) {
                ...
                var u = function(t, e, i, n) {
                    var s, o = "undefined" != typeof window && window.URL, h = o ? "blob" : "arraybuffer", l = new r.defer, c = new XMLHttpRequest, u = XMLHttpRequest.prototype;
                    ...
                    i && (c.withCredentials = !0),
                        c.onreadystatechange = function() {
                            if (this.readyState === XMLHttpRequest.DONE) {
                                var t = !1;
                                if ("" !== this.responseType && "document" !== this.responseType || (t = this.responseXML),
                                200 === this.status || 0 === this.status || t) {
                                    ...
                                    if (403 === this.status)
                                        return l.reject({
                                            ...
                                            l.promise;
                                    i = t ? this.responseXML : Object(r.isXml)(e) ? Object(r.parse)(this.response, "text/xml") : "xhtml" == e ? Object(r.parse)(this.response, "application/xhtml+xml") : "html" == e || "htm" == e ? Object(r.parse)(this.response, "text/html") : "json" == e ? JSON.parse(this.response) : "blob" == e ? o ? this.response : new Blob([this.response]) : this.response,
                                        l.resolve(i)
                                } else
                                    l.reject({
                                        status: this.status,
                    ...
                    return "json" == e && c.setRequestHeader("Accept", "application/json"),
                ...
                var f = class {
                        ...
                        render(t) {
                            ...
                            return this.output,
                                this.load(t).then(function(t) {
                                    ...
                                    return this.output = i.serializeToString(t),
                                        this.output
                                }
                                    .bind(this)).then(function() {
                        ...
                        find(t) {
                            ...
                            return Object(r.sprint)(e.document, (function(t) {
                                    !function(t) {
                                        for (var s, r, o, a = t.textContent.toLowerCase(), h = e.document.createRange(), l = -1; -1 != r; )
                                            -1 != (r = a.indexOf(n, l + 1)) && ((h = e.document.createRange()).setStart(t, r),
                                                h.setEnd(t, r + n.length),
                                                s = e.cfiFromRange(h),
                                                o = t.textContent.length < 150 ? t.textContent : "..." + (o = t.textContent.substring(r - 75, r + 75)) + "...",
                                                i.push({
                                                    cfi: s,
                                                    excerpt: o
                                                })),
                        ...
                        search(t, e=5) {
                            ...
                            const n = this
                                ...
                                if (-1 != e) {
                                    ...
                                    if (e < t[r].length) {
                                        ...
                                        f.length > 150 && (f = f.substring(e - 75, e + 75),
                                            f = "..." + f + "..."),
                                            i.push({
                                                cfi: s,
                                                excerpt: f
                            ...
                            for (; a = o.nextNode(); )
                                h.push(a),
                                h.length == e && (r(h.slice(0, e)),
                                    h = h.slice(1, e));
                            return h.length > 0 && r(h),
                                i
                        }
                        reconcileLayoutSettings(t) {
                            ...
                            return this.properties.forEach((function(t) {
                                    var i, n, s = t.replace("rendition:", ""), r = s.indexOf("-");
                                    -1 != r && (i = s.slice(0, r),
                                        n = s.slice(r + 1),
                                        e[i] = n)
                                }
                ...
                var p = class {
                    ...
                    get(t) {
                        ...
                        if (void 0 === t)
                            ...
                            "number" == typeof t || !1 === isNaN(t) ? e = t : "string" == typeof t && 0 === t.indexOf("#") ? e = this.spineById[t.substring(1)] : "string" == typeof t && (t = t.split("#")[0],
                    ...
                    prepend(t) {
                        return this.spineByHref[t.href] = 0,
                    ...
                    remove(t) {
                        ...
                        if (e > -1)
                            return delete this.spineByHref[t.href],
                ...
                class v {
                    ...
                    generate(t) {
                        return t && (this.break = t),
                            this.q.pause(),
                            this.spine.each(function(t) {
                                t.linear && this.q.enqueue(this.process.bind(this), t)
                            }
                                .bind(this)),
                            this.q.run().then(function() {
                                return this.total = this._locations.length - 1,
                    ...
                    process(t) {
                        return t.load(this.request).then(function(e) {
                            ...
                            return this._locations = this._locations.concat(n),
                                t.unload(),
                    ...
                    parse(t, e, i) {
                        var n, s, o = [], a = t.ownerDocument, l = Object(r.qs)(a, "body"), c = 0, u = i || this.break;
                        if (Object(r.sprint)(l, function(t) {
                            var i, r = t.length, a = 0;
                            if (0 === t.textContent.trim().length)
                                return !1;
                            for (0 == c && ((n = this.createRange()).startContainer = t,
                                n.startOffset = 0),
                                 (i = u - c) > r && (c += r,
                                     a = r); a < r; )
                                if (i = u - c,
                    ...
                    generateFromWords(t, e, i) {
                        ...
                        return this.q.pause(),
                            ...
                            this.spine.each(function(t) {
                                ...
                                .bind(this)),
                            this.q.run().then(function() {
                                return this._currentCfi && (this.currentLocation = this._currentCfi),
                                    this._locationsWords
                            }
                                .bind(this))
                    }
                    processWords(t, e, i, n) {
                        return n && this._locationsWords.length >= n ? Promise.resolve() : t.load(this.request).then(function(s) {
                            ...
                            return this._locationsWords = this._locationsWords.concat(a.length >= n ? a.slice(0, h) : a),
                                t.unload(),
                    ...
                    parseWords(t, e, i, n) {
                        var s, o = e.cfiBase, a = [], l = t.ownerDocument, c = Object(r.qs)(l, "body"), u = i, d = !n || n.spinePos !== e.index;
                        ...
                        return Object(r.sprint)(c, function(t) {
                            ...
                            if (t.textContent.length < 10 && 0 === t.textContent.trim().length)
                                return !1;
                            var e, i = this.countWords(t.textContent), n = 0;
                            if (0 === i)
                                return !1;
                            for ((e = u - this._wordCounter) > i && (this._wordCounter += i,
                                n = i); n < i; )
                                if (n + (e = u - this._wordCounter) >= i)
                                    this._wordCounter += i - n,
                                        n = i;
                                else {
                                    n += e;
                                    let i = new h.a(t,o);
                    ...
                    locationFromCfi(t) {
                        let e;
                        return h.a.prototype.isCfiString(t) && (t = new h.a(t)),
                            0 === this._locations.length ? -1 : (e = Object(r.locationOf)(t, this._locations, this.epubcfi.compare),
                    ...
                    cfiFromPercentage(t) {
                        ...
                        return e = Math.ceil(this.total * t),
                            this.cfiFromLocation(e)
                    }
                    load(t) {
                        return this._locations = "string" == typeof t ? JSON.parse(t) : t,
                    ...
                    setCurrent(t) {
                        ...
                        0 !== this._locations.length && ("string" == typeof t ? (e = this.locationFromCfi(t),
                            this._current = e) : e = t,
                ...
                var E = class {
                        ...
                        parse(t) {
                            ...
                            return this.manifest = this.parseManifest(i),
                        ...
                        parseMetadata(t) {
                            var e = {};
                            return e.title = this.getElementText(t, "title"),
                        ...
                        findNcxPath(t, e) {
                            ...
                            return n || (i = e.getAttribute("toc")) && (n = t.querySelector("#" + i)),
                        ...
                        load(t) {
                            ...
                            return this.spine = e.map( (t, e) => (t.index = e,
                                ...
                                this.spineNodeIndex = 0,
                                this.toc = t.toc.map( (t, e) => (t.label = t.title,
                                    t)),
                                {
                                    metadata: this.metadata,
                                    spine: this.spine,
                ...
                var S = class {
                    ...
                    parse(t) {
                        ...
                        n && (e = Object(r.qs)(t, "html"),
                            i = Object(r.qs)(t, "ncx")),
                            n ? e ? (this.toc = this.parseNav(t),
                                this.landmarks = this.parseLandmarks(t)) : i && (this.toc = this.parseNcx(t)) : this.toc = this.load(t),
                            this.length = 0,
                    ...
                    get(t) {
                        var e;
                        return t ? (0 === t.indexOf("#") ? e = this.tocById[t.substring(1)] : t in this.tocByHref && (e = this.tocByHref[t]),
                            this.getByIndex(t, e, this.toc)) : this.toc
                    }
                    getByIndex(t, e, i) {
                        if (0 === i.length)
                            return;
                        ...
                        if (!n || t !== n.id && t !== n.href) {
                            let n;
                            for (let s = 0; s < i.length && (n = this.getByIndex(t, e, i[s].subitems),
                                !n); ++s)
                                ;
                            return n
                        }
                    ...
                    landmark(t) {
                        var e;
                        return t ? (e = this.landmarksByType[t],
                            this.landmarks[e]) : this.landmarks
                    }
                    parseNav(t) {
                    ...
                    parseLandmarks(t) {
                        var e, i, n = Object(r.querySelectorByType)(t, "nav", "landmarks"), s = n ? Object(r.qsa)(n, "li") : [], o = s.length, a = [];
                        if (!s || 0 === o)
                            return a;
                        for (e = 0; e < o; ++e)
                            (i = this.landmarkItem(s[e])) && (a.push(i),
                                this.landmarksByType[i.type] = e);
                        return a
                    }
                    landmarkItem(t) {
                    ...
                    parseNcx(t) {
                        var e, i, n = Object(r.qsa)(t, "navPoint"), s = n.length, o = {}, a = [];
                        if (!n || 0 === s)
                            return a;
                        for (e = 0; e < s; ++e)
                    ...
                    ncxItem(t) {
                        var e, i = t.getAttribute("id") || !1, n = Object(r.qs)(t, "content").getAttribute("src"), s = Object(r.qs)(t, "navLabel"), o = s.textContent ? s.textContent : "", a = t.parentNode;
                    ...
                    load(t) {
                        return t.map(t => (t.label = t.title,
                ...
                var C = class {
                        ...
                        replacements() {
                            ...
                            var t = this.urls.map(t => {
                                    ...
                                    return this.createUrl(e).catch(t => (console.error(t),
                                        null))
                                }
                            );
                            return Promise.all(t).then(t => (this.replacementUrls = t.filter(t => "string" == typeof t),
                                t))
                        }
                        replaceCss(t, e) {
                            var i = [];
                            return t = t || this.settings.archive,
                                e = e || this.settings.resolver,
                                this.cssUrls.forEach(function(n) {
                        ...
                        createCssFile(t) {
                            ...
                            return e ? e.then(t => (t = Object(c.e)(t, n, this.replacementUrls),
                                "base64" === this.settings.replacements ? Object(r.createBase64Url)(t, "text/css") : Object(r.createBlobUrl)(t, "text/css")), t => new Promise((function(t) {
                                    t()
                                }
                        ...
                        relativeTo(t, e) {
                            return e = e || this.settings.resolver,
                                this.urls.map(function(i) {
                                    var n = e(i);
                        ...
                        get(t) {
                            ...
                            if (-1 !== e)
                                return this.replacementUrls.length ? new Promise(function(t, i) {
                        ...
                        substitute(t, e) {
                            var i;
                            return i = e ? this.relativeTo(e) : this.urls,
                ...
                var O = class {
                    ...
                    parseNav(t) {
                        var e, i, n = Object(r.querySelectorByType)(t, "nav", "page-list"), s = n ? Object(r.qsa)(n, "li") : [], o = s.length, a = [];
                        if (!s || 0 === o)
                            return a;
                        for (e = 0; e < o; ++e)
                            i = this.item(s[e]),
                    ...
                    parseNcx(t) {
                        var e, i, n, s, o = [], a = 0;
                        if (!(i = Object(r.qs)(t, "pageList")))
                            return o;
                        if (s = (n = Object(r.qsa)(i, "pageTarget")).length,
                        !n || 0 === n.length)
                            return o;
                        for (a = 0; a < s; ++a)
                            e = this.ncxItem(n[a]),
                    ...
                    item(t) {
                        var e, i, n = Object(r.qs)(t, "a"), s = n.getAttribute("href") || "", o = n.textContent || "", a = parseInt(o);
                    ...
                    pageFromCfi(t) {
                        ...
                        return -1 != i ? e = this.pages[i] : void 0 !== (e = (i = Object(r.locationOf)(t, this.locations, this.epubcfi.compare)) - 1 >= 0 ? this.pages[i - 1] : this.pages[0]) || (e = -1),
                            e
                    }
                    cfiFromPage(t) {
                        var e = -1;
                ...
                var A = class {
                    ...
                    request(t, e) {
                        var i, n = new r.defer, s = new a.a(t);
                        return e || (e = s.extension),
                            (i = "blob" == e ? this.getBlob(t) : this.getText(t)) ? i.then(function(t) {
                    ...
                    createUrl(t, e) {
                        var i, n, s = new r.defer, o = window.URL || window.webkitURL || window.mozURL, a = e && e.base64;
                        return t in this.urlCache ? (s.resolve(this.urlCache[t]),
                            s.promise) : (a ? (n = this.getBase64(t)) && n.then(function(e) {
                            this.urlCache[t] = e,
                                s.resolve(e)
                        }
                ...
                class D {
                    ...
                    request(t, e, i, n) {
                        return this.online ? this.requester(t, e, i, n).then(e => (this.put(t),
                            e)) : this.retrieve(t, e)
                    }
                    retrieve(t, e) {
                        new r.defer;
                        var i = new a.a(t);
                        return e || (e = i.extension),
                            ("blob" == e ? this.getBlob(t) : this.getText(t)).then(i => {
                                    var n, s = new r.defer;
                                    return i ? (n = this.handleResponse(i, e),
                    ...
                    getText(t, e) {
                        ...
                        return e = e || T.lookup(t),
                            this.storage.getItem(i).then((function(t) {
                                    var i, n = new r.defer, s = new FileReader;
                                    if (t)
                                        return i = new Blob([t],{
                                            type: e
                                        }),
                ...
                var M = class {
                        ...
                        parse(t) {
                            ...
                            return Object(r.qsa)(e, "option").forEach(t => {
                                    let e = "";
                                    switch (t.childNodes.length && (e = t.childNodes[0].nodeValue),
                ...
                class H {
                    constructor(t, e) {
                        void 0 === e && "string" != typeof t && t instanceof Blob == !1 && t instanceof ArrayBuffer == !1 && (e = t,
                            t = void 0),
                            this.settings = Object(r.extend)(this.settings || {}, {
                        ...
                        t && this.open(t, this.settings.openAs).catch(e => {
                    ...
                    open(t, e) {
                        ...
                        return n === z ? (this.archived = !0,
                            this.url = new o.a("/",""),
                            i = this.openEpub(t)) : n === B ? (this.archived = !0,
                            this.url = new o.a("/",""),
                            i = this.openEpub(t, n)) : n === q ? (this.archived = !0,
                            this.url = new o.a("/",""),
                            i = this.request(t, "binary", this.settings.requestCredentials, this.settings.requestHeaders).then(this.openEpub.bind(this))) : n == F ? (this.url = new o.a(t),
                            i = this.openPackaging(this.url.Path.toString())) : n == U ? (this.url = new o.a(t),
                            i = this.openManifest(this.url.Path.toString())) : (this.url = new o.a(t),
                    ...
                    openContainer(t) {
                        return this.load(t).then(t => (this.container = new x(t),
                            this.resolve(this.container.packagePath)))
                    }
                    openPackaging(t) {
                        return this.path = new a.a(t),
                            this.load(t).then(t => (this.packaging = new E(t),
                                this.unpack(this.packaging)))
                    }
                    openManifest(t) {
                        return this.path = new a.a(t),
                            this.load(t).then(t => (this.packaging = new E,
                    ...
                    resolve(t, e) {
                        if (t) {
                            var i = t;
                            return t.indexOf("://") > -1 ? t : (this.path && (i = this.path.resolve(t)),
                    ...
                    determineType(t) {
                        var e;
                        return "base64" === this.settings.encoding ? B : "string" != typeof t ? z : ((e = new o.a(t).path().extension) && (e = e.replace(/\?.*$/, "")),
                            e ? "epub" === e ? q : "opf" === e ? F : "json" === e ? U : void 0 : W)
                    }
                    unpack(t) {
                        this.package = t,
                            "" === this.packaging.metadata.layout ? this.load(this.url.resolve("META-INF/com.apple.ibooks.display-options.xml")).then(t => {
                        ...
                        this.packaging.coverPath && (this.cover = this.resolve(this.packaging.coverPath)),
                            ...
                            this.isOpen = !0,
                            this.archived || this.settings.replacements && "none" != this.settings.replacements ? this.replacements().then( () => {
                    ...
                    loadNavigation(t) {
                        ...
                        ) : e ? this.load(e, "xml").then(t => (this.navigation = new S(t),
                            this.pageList = new O(t),
                            this.navigation)) : new Promise( (t, e) => {
                    ...
                    renderTo(t, e) {
                        return this.rendition = new I.a(this,e),
                            ...
                            this.opened.then( () => {
                                    ...
                                    this.resources.settings.replacements = e || "blobUrl",
                                        ...
                                        this.storage.on("online", () => {
                                                this.url = i,
                                                    this.spine.hooks.serialize.deregister(t)
                                            }
                                        )
                                }
                            ),
            ...
            , function(t, e, i) {
                ...
                function h(t, e) {
                    ...
                    i.constructor != t && ("function" != typeof t && console.error("unknown Class:" + t),
                        i.constructor = t)
                }
                var l = {}
                    , c = l.ELEMENT_NODE = 1
                    ...
                    , E = {}
                    , S = {}
                    , N = (E.INDEX_SIZE_ERR = (S[1] = "Index size error",
                    1),
                    E.DOMSTRING_SIZE_ERR = (S[2] = "DOMString size error",
                        2),
                    E.HIERARCHY_REQUEST_ERR = (S[3] = "Hierarchy request error",
                        3))
                    , _ = (E.WRONG_DOCUMENT_ERR = (S[4] = "Wrong document",
                    4),
                    E.INVALID_CHARACTER_ERR = (S[5] = "Invalid character",
                        5),
                    E.NO_DATA_ALLOWED_ERR = (S[6] = "No data allowed",
                        6),
                    E.NO_MODIFICATION_ALLOWED_ERR = (S[7] = "No modification allowed",
                        7),
                    E.NOT_FOUND_ERR = (S[8] = "Not found",
                        8))
                    , T = (E.NOT_SUPPORTED_ERR = (S[9] = "Not supported",
                    9),
                    E.INUSE_ATTRIBUTE_ERR = (S[10] = "Attribute in use",
                        10));
                E.INVALID_STATE_ERR = (S[11] = "Invalid state",
                    11),
                    E.SYNTAX_ERR = (S[12] = "Syntax error",
                        12),
                    E.INVALID_MODIFICATION_ERR = (S[13] = "Invalid modification",
                        13),
                    E.NAMESPACE_ERR = (S[14] = "Invalid namespace",
                        14),
                    E.INVALID_ACCESS_ERR = (S[15] = "Invalid access",
                        15);
                function C(t, e) {
                ...
                function j(t, e, i) {
                    var n = A(e, i);
                    if (!(n >= 0))
                        throw C(_, new Error(t.tagName + "@" + i));
                    for (var s = e.length - 1; n < s; )
                        e[n] = e[++n];
                    if (e.length = s,
                        t) {
                        var r = t.ownerDocument;
                ...
                function q(t, e, i, s) {
                    t && t._inc++,
                    i.namespaceURI === n.XMLNS && delete e._nsMap[i.prefix ? i.localName : ""]
                }
                function F(t, e, i) {
                    if (t && t._inc) {
                        t._inc++;
                ...
                function U(t, e) {
                    var i = e.previousSibling
                        , n = e.nextSibling;
                    return i ? i.nextSibling = n : t.firstChild = n,
                ...
                C.prototype = Error.prototype,
                    ...
                    k.prototype = {
                        ...
                        setNamedItem: function(t) {
                            ...
                            return L(this._ownerElement, this, t, i),
                                i
                        },
                        ...
                        removeNamedItem: function(t) {
                            ...
                            return j(this._ownerElement, this, e),
                                e
                        },
                        removeNamedItemNS: function(t, e) {
                            var i = this.getNamedItemNS(t, e);
                            return j(this._ownerElement, this, i),
                                i
                        },
                    ...
                    B.prototype = {
                        ...
                        insertBefore: function(t, e) {
                            ...
                            return null == this.documentElement && t.nodeType == c && (this.documentElement = t),
                                W(this, t, e),
                        ...
                        createElementNS: function(t, e) {
                            ...
                            return i.childNodes = new O,
                                i.ownerDocument = this,
                                i.nodeName = e,
                                i.tagName = e,
                                i.namespaceURI = t,
                                2 == n.length ? (i.prefix = n[0],
                                    i.localName = n[1]) : i.localName = e,
                                s._ownerElement = i,
                                i
                        },
            ...
            , function(t, e, i) {
                ...
                (t.exports = function(t, e) {
                        var i, r, a, h, l;
                        return arguments.length < 2 || "string" != typeof t ? (h = e,
                            e = t,
                            t = null) : h = arguments[2],
                            null == t ? (i = a = !0,
                                r = !1) : (i = o.call(t, "c"),
                                r = o.call(t, "e"),
                                a = o.call(t, "w")),
                    ...
                    var a, h, l, c;
                    return "string" != typeof t ? (l = i,
                        i = e,
                        e = t,
                        t = null) : l = arguments[3],
                        null == e ? e = void 0 : r(e) ? null == i ? i = void 0 : r(i) || (l = i,
                            i = void 0) : (l = e,
                            e = i = void 0),
                        null == t ? (a = !0,
                            h = !1) : (a = o.call(t, "c"),
            ...
            , function(t, e, i) {
                ...
                u.prototype.parseFromString = function(t, e) {
                    ...
                    return a && s.setDocumentLocator(a),
            ...
            , function(t, e, i) {
                ...
                function c(t, e, i, s, r, o) {
                    ...
                    for (var h, l = ++e, c = 0; ; ) {
                        ...
                        switch (u) {
                            ...
                            case '"':
                                if (3 === c || 1 === c) {
                                    if (1 === c && (o.warning('attribute value must after "="'),
                                        h = t.slice(e, l)),
                                        e = l + 1,
                                        !((l = t.indexOf(u, e)) > 0))
                            ...
                            case ">":
                                switch (c) {
                                    ...
                                    case 4:
                                    case 1:
                                        "/" === (d = t.slice(e, l)).slice(-1) && (i.closed = !0,
                                            d = d.slice(0, -1));
                                    case 2:
                                        2 === c && (d = h),
                                            4 == c ? (o.warning('attribute "' + d + '" missed quot(")!'),
                                                a(h, d.replace(/&#?\w+;/g, r), e)) : (n.isHTML(s[""]) && d.match(/^(?:disabled|checked|selected)$/i) || o.warning('attribute "' + d + '" missed value!! "' + d + '" instead!!'),
                                                a(d, d, e));
                                        break;
                                    case 3:
                            ...
                            default:
                                if (u <= " ")
                                    ...
                                    switch (c) {
                                        case 2:
                                            i.tagName;
                                            n.isHTML(s[""]) && h.match(/^(?:disabled|checked|selected)$/i) || o.warning('attribute "' + h + '" missed value!! "' + h + '" instead2!!'),
                                                a(h, h, e),
                                                e = l,
                                                c = 1;
                                            break;
                ...
                function u(t, e, i) {
                    ...
                    for (o = t.length; o--; ) {
                        (c = (a = t[o]).prefix) && ("xml" === c && (a.uri = n.XML),
                        "xmlns" !== c && (a.uri = i[c || ""]))
                    }
                    var f;
                    (f = s.indexOf(":")) > 0 ? (c = t.prefix = s.slice(0, f),
                        u = t.localName = s.slice(f + 1)) : (c = null,
                        u = t.localName = s);
                    var g = t.uri = i[c || ""];
                    if (e.startElement(g, u, s, t),
                        !t.closed)
                        return t.currentNSMap = i,
                            t.localNSMap = r,
                            !0;
                    if (e.endElement(g, u, s),
                        r)
                        for (c in r)
                ...
                function d(t, e, i, n, s) {
                    if (/^(?:script|textarea)$/i.test(i)) {
                        var r = t.indexOf("</" + i + ">", e)
                            , o = t.substring(e + 1, r);
                        if (/[&<]/.test(o))
                            return /^script$/i.test(i) ? (s.characters(o, 0, o.length),
                                r) : (o = o.replace(/&#?\w+;/g, n),
                ...
                function f(t, e, i, n) {
                    var s = n[i];
                    return null == s && ((s = t.lastIndexOf("</" + i + ">")) < e && (s = t.lastIndexOf("</" + i)),
                        n[i] = s),
                    s < e
                }
                function p(t, e) {
                ...
                function g(t, e, i, n) {
                    switch (t.charAt(e + 2)) {
                        case "-":
                            return "-" === t.charAt(e + 3) ? (s = t.indexOf("--\x3e", e + 4)) > e ? (i.comment(t, e + 4, s - e - 4),
                            s + 3) : (n.error("Unclosed comment"),
                                -1) : -1;
                        default:
                            ...
                            if (o > 1 && /!doctype/i.test(r[0][0])) {
                                var a = r[1][0]
                                    , h = !1
                                    , l = !1;
                                o > 3 && (/^public$/i.test(r[2][0]) ? (h = r[3][0],
                                    l = o > 4 && r[4][0]) : /^system$/i.test(r[2][0]) && (l = r[3][0]));
                                var c = r[o - 1];
                                return i.startDTD(a, h, l),
                                    i.endDTD(),
                                c.index + c[0].length
                            }
                    }
                ...
                function m(t, e, i) {
                    ...
                    if (n) {
                        ...
                        if (s) {
                            s[0].length;
                            return i.processingInstruction(s[1], s[2]),
                            n + 2
                        }
                        return -1
                    }
                            ...
                            s.startDocument(),
                                ...
                                function(t, e, i, s, r) {
                                    function o(t) {
                                        ...
                                        }(parseInt(e.substr(1).replace("x", "0x"))) : (r.error("entity not found:" + t),
                                            t)
                                    }
                                    function h(e) {
                                        if (e > N) {
                                            ...
                                            switch (_ > N && h(_),
                                                ...
                                                default:
                                                    ...
                                                    var j = new v
                                                        ...
                                                        , P = (O = c(t, _, j, D, o, r),
                                                        j.length);
                                                    if (!j.closed && f(t, O, j.tagName, S) && (j.closed = !0,
            ...
            , function(t, e, i) {
                    ...
                    function i(i) {
                        for (var n = e.length - 1; n >= 0; n--) {
                            var o = e[n]
                                , a = i.clientX
                                , h = i.clientY;
                            if (i.touches && i.touches.length && (a = i.touches[0].clientX,
                ...
                function s(t) {
                    ...
                    try {
                        ...
                        return i.initMouseEvent(t.type, !1, e.cancelable, e.view, e.detail, e.screenX, e.screenY, e.clientX, e.clientY, e.ctrlKey, e.altKey, e.shiftKey, e.metaKey, e.button, e.relatedTarget),
                            i
                    }
                }
                function r(t, e, i, n) {
                    ...
                    if (!r(t.getBoundingClientRect(), i, n))
                        return !1;
