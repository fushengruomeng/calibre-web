 ...
 */
!function(a, b) {
    "object" == typeof exports && "undefined" != typeof module ? b(exports) : "function" == typeof define && define.amd ? define(["exports"], b) : b(a.RSVP = a.RSVP || {})
}(this, function(a) {
    "use strict";
    function b(a, b) {
    ...
    function q(a, b) {
        b._state === Ca ? u(a, b._result) : b._state === Da ? (b._onError = null,
            v(a, b._result)) : w(b, void 0, function(c) {
            b !== c ? s(a, c, void 0) : u(a, c)
        }, function(b) {
            return v(a, b)
        })
    ...
    function r(a, b, c) {
        b.constructor === a.constructor && c === C && a.constructor.resolve === k ? q(a, b) : c === Ea ? (v(a, Ea.error),
            Ea.error = null) : f(c) ? p(a, b, c) : u(a, b)
    }
    function s(a, b) {
    ...
    function u(a, b) {
        a._state === Ba && (a._result = b,
            a._state = Ca,
            0 === a._subscribers.length ? wa.instrument && j("fulfilled", a) : wa.async(x, a))
    }
    function v(a, b) {
        a._state === Ba && (a._state = Da,
            a._result = b,
            wa.async(t, a))
    }
    function w(a, b, c, d) {
    ...
    function x(a) {
        var b = a._subscribers
            , c = a._state;
        if (wa.instrument && j(c === Ca ? "fulfilled" : "rejected", a),
        0 !== b.length) {
    ...
    function A(a, b, c, d) {
        ...
        if (e) {
            ...
            g = d;
        b._state !== Ba || (e && void 0 === h ? s(b, g) : void 0 !== h ? v(b, h) : a === Ca ? u(b, g) : a === Da && v(b, g))
    }
    function B(a, b) {
        var c = !1;
        try {
    ...
    function C(a, b, c) {
        var d = this
            , e = d._state;
        if (e === Ca && !a || e === Da && !b)
            return wa.instrument && j("chained", d, d),
                d;
        d._onError = null;
        var f = new d.constructor(m,c)
            , g = d._result;
        if (wa.instrument && j("chained", d, f),
        e === Ba)
            w(d, f, a, b);
        else {
            var h = e === Ca ? a : b;
    ...
    function E(a, b) {
        return ya(a) ? new Ga(this,a,!0,b).promise : this.reject(new TypeError("Promise.all must be called with an array"), b)
    }
    function F(a, b) {
        var c = this
            , d = new c(m,b);
        if (!ya(a))
            return v(d, new TypeError("Promise.race must be called with an array")),
                d;
    ...
    function P(a, b) {
        var c = function() {
            ...
            return e[d] = function(a, c) {
                a ? v(j, a) : void 0 === b ? s(j, c) : !0 === b ? s(j, N(arguments)) : ya(b) ? s(j, M(arguments, b)) : s(j, c)
            }
                ,
    ...
    function W(a, b) {
        return ya(a) ? new Ma(Ja,a,b).promise : Ja.reject(new TypeError("Promise.allSettled must be called with an array"), b)
    }
    function X(a, b) {
        return Ja.race(a, b)
    }
    ...
    function $(a, b) {
        return g(a) ? new Oa(Ja,a,b).promise : Ja.reject(new TypeError("Promise.hash must be called with an object"), b)
    }
    function _(a, b) {
        if (!a)
            throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
    ...
    function ba(a, b) {
        return g(a) ? new Pa(Ja,a,!1,b).promise : Ja.reject(new TypeError("RSVP.hashSettled must be called with an object"), b)
    }
    function ca(a) {
    ...
    function da(a) {
        ...
        return b.promise = new Ja(function(a, c) {
                b.resolve = a,
                    b.reject = c
            }
            ,a),
    ...
    function ea(a, b, c) {
        return ya(a) ? f(b) ? Ja.all(a, c).then(function(a) {
            for (var d = a.length, e = new Array(d), f = 0; f < d; f++)
                e[f] = b(a[f]);
            return Ja.all(e, c)
        }) : Ja.reject(new TypeError("RSVP.map expects a function as a second argument"), c) : Ja.reject(new TypeError("RSVP.map must be called with an array"), c)
    }
    function fa(a, b) {
    ...
    function ja(a, b, c) {
        return ya(a) || g(a) && void 0 !== a.then ? f(b) ? (ya(a) ? ha(a, c) : ia(a, c)).then(function(a) {
            for (var d = a.length, e = new Array(d), f = 0; f < d; f++)
                e[f] = b(a[f]);
        ...
        }) : Ja.reject(new TypeError("RSVP.filter expects function as a second argument"), c) : Ja.reject(new TypeError("RSVP.filter must be called with an array or promise"), c)
    }
    function ka(a, b) {
        Xa[Qa] = a,
            Xa[Qa + 1] = b,
    ...
    function ra() {
        try {
            var a = require
                , b = a("vertx");
            return Ra = b.runOnLoop || b.runOnContext,
                ma()
        } catch (a) {
            return pa()
        }
    ...
    va.mixin(wa);
    var xa = void 0;
    xa = Array.isArray ? Array.isArray : function(a) {
    ...
    var ya = xa
        ...
        return a.prototype._init = function(a, b) {
            var c = b.length || 0;
            this.length = c,
                this._remaining = c,
            ...
            a.prototype._enumerate = function(a) {
                for (var b = this.length, c = this.promise, d = 0; c._state === Ba && d < b; d++)
            ...
            a.prototype._eachEntry = function(a, b) {
                h(a) ? this._settleMaybeThenable(a, b) : (this._remaining--,
                    this._result[b] = this._makeResult(Ca, b, a))
            }
            ,
            a.prototype._settledAt = function(a, b, c) {
                var d = this.promise;
                d._state === Ba && (this._abortOnReject && a === Da ? v(d, c) : (this._remaining--,
        ...
        return a.prototype._onError = function(a) {
            var b = this;
            wa.after(function() {
        ...
        return Z(b, a),
            ...
            b.prototype._enumerate = function(a) {
                ...
                for (var f = void 0, g = 0; b._state === Ba && g < e; g++)
                    f = c[g],
                        this._eachEntry(f.entry, f.position)
            }
            ,
            b
    }(Ga)
    ...
    var Qa = 0
        ...
        , Va = "undefined" == typeof self && "undefined" != typeof process && "[object process]" === {}.toString.call(process)
        , Wa = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel
        , Xa = new Array(1e3)
        , Ya = void 0;
    Ya = Va ? la() : Ua ? na() : Wa ? oa() : void 0 === Sa && "function" == typeof require ? ra() : pa();
    ...
    if ("undefined" != typeof window && "object" == typeof window.__PROMISE_INSTRUMENTATION__) {
        ...
        d("instrument", !0);
        for (var bb in ab)
            ab.hasOwnProperty(bb) && ta(bb, ab[bb])
    }
    var cb = (Za = {
        asap: ka,
        cast: $a,
...
EPUBJS.core.getEl = function(a) {
    ...
    EPUBJS.core.request = function(a, b, c) {
        var d, e = window.URL, f = e ? "blob" : "arraybuffer", g = new RSVP.defer, h = new XMLHttpRequest, i = XMLHttpRequest.prototype, j = function() {
            var a;
    ...
    EPUBJS.core.uri = function(a) {
        ...
        return 0 === f ? (e.protocol = "blob",
            ...
            e) : (-1 != i && (e.fragment = a.slice(i + 1),
            a = a.slice(0, i)),
        -1 != h && (e.search = a.slice(h + 1),
            a = a.slice(0, h),
            href = e.href),
            -1 != g ? (e.protocol = a.slice(0, g),
                b = a.slice(g + 3),
                d = b.indexOf("/"),
                -1 === d ? (e.host = e.path,
    ...
    EPUBJS.core.locationOf = function(a, b, c, d, e) {
        ...
        return c || (c = function(a, b) {
            ...
            h - g <= 0 ? i : (f = c(b[i], a),
                h - g == 1 ? f > 0 ? i : i + 1 : 0 === f ? i : -1 === f ? EPUBJS.core.locationOf(a, b, c, i, h) : EPUBJS.core.locationOf(a, b, c, g, i))
    }
    ,
    EPUBJS.core.indexOfSorted = function(a, b, c, d, e) {
        ...
        return c || (c = function(a, b) {
            ...
            h - g <= 0 ? -1 : (f = c(b[i], a),
                h - g == 1 ? 0 === f ? i : -1 : 0 === f ? i : -1 === f ? EPUBJS.core.indexOfSorted(a, b, c, i, h) : EPUBJS.core.indexOfSorted(a, b, c, g, i))
    }
    ,
    ...
    EPUBJS.core.indexOfNode = function(a, b) {
        for (var c, d = a.parentNode, e = d.childNodes, f = -1, g = 0; g < e.length && (c = e[g],
        c.nodeType === b && f++,
        c != a); g++)
            ;
        return f
...
EPUBJS.reader = {},
    ...
    EPUBJS.Reader = function(a, b) {
        ...
        this.settings.generatePagination && c.generatePagination(g.width(), g.height()),
            ...
            this.settings.previousLocationCfi ? this.displayed = this.rendition.display(this.settings.previousLocationCfi) : this.displayed = this.rendition.display(),
            c.ready.then(function() {
                f.ReaderController = EPUBJS.reader.ReaderController.call(f, c),
                    ...
                    this.rendition.on("keydown", f.ReaderController.arrowKeys.bind(this)),
        ...
        return c.loaded.metadata.then(function(a) {
    ...
    EPUBJS.Reader.prototype.adjustFontSize = function(a) {
        var b, c = 2, d = a.ctrlKey || a.metaKey;
        ...
        d && 187 == a.keyCode && (a.preventDefault(),
            this.book.setStyle("fontSize", b + c + "%")),
        d && 189 == a.keyCode && (a.preventDefault(),
            this.book.setStyle("fontSize", b - c + "%")),
        d && 48 == a.keyCode && (a.preventDefault(),
            this.book.setStyle("fontSize", "100%")))
    }
    ,
    EPUBJS.Reader.prototype.addBookmark = function(a) {
        this.isBookmarked(a) > -1 || (this.settings.bookmarks.push(a),
    ...
    EPUBJS.Reader.prototype.saveSettings = function() {
        if (this.book && (this.settings.previousLocationCfi = this.rendition.currentLocation().start.cfi),
            !localStorage)
            return !1;
    ...
    EPUBJS.Reader.prototype.selectedRange = function(a) {
        var b = "#" + a;
        this.settings.history && window.location.hash != b && (history.pushState({}, "", b),
            this.currentLocationCfi = a)
    }
    ,
    ...
    EPUBJS.reader.BookmarksController = function() {
        var a = this.book
            ...
            var f, g = a.spine.get(c);
            return g.index in a.navigation.toc ? (f = a.navigation.toc[g.index],
                e.textContent = f.label) : e.textContent = c,
                e.href = c,
    ...
    EPUBJS.reader.ControlsController = function(a) {
        ...
        return e.on("click", function() {
            b.sidebarOpen ? (b.SidebarController.hide(),
                ...
                e.removeClass("icon-right")) : (b.SidebarController.show(),
        ...
        "undefined" != typeof screenfull && (d.on("click", function() {
            screenfull.toggle($("#container")[0])
        }),
        screenfull.raw && document.addEventListener(screenfull.raw.fullscreenchange, function() {
            fullscreen = screenfull.isFullscreen,
                fullscreen ? d.addClass("icon-resize-small").removeClass("icon-resize-full") : d.addClass("icon-resize-full").removeClass("icon-resize-small")
        })),
            f.on("click", function() {
            ...
            g.on("click", function() {
                ...
                -1 === b.isBookmarked(a) ? (b.addBookmark(a),
                    g.addClass("icon-bookmark").removeClass("icon-bookmark-empty")) : (b.removeBookmark(a),
                    g.removeClass("icon-bookmark").addClass("icon-bookmark-empty"))
            }),
            c.on("relocated", function(a) {
                var c = a.start.cfi
                    , d = "#" + c;
                -1 === b.isBookmarked(c) ? g.removeClass("icon-bookmark").addClass("icon-bookmark-empty") : g.addClass("icon-bookmark").removeClass("icon-bookmark-empty"),
                    b.currentLocationCfi = c,
                b.settings.history && window.location.hash != d && history.pushState({}, "", d)
            }),
            {}
    }
    ,
    ...
    EPUBJS.reader.NotesController = function() {
        var a = this.book
            ...
            , n = function(d) {
            var e, h, i, j, l, m = a.renderer.doc;
            if (m.caretPositionFromPoint ? (e = m.caretPositionFromPoint(d.clientX, d.clientY),
                h = e.offsetNode,
                i = e.offset) : m.caretRangeFromPoint && (e = m.caretRangeFromPoint(d.clientX, d.clientY),
                h = e.startContainer,
                i = e.startOffset),
            3 !== h.nodeType)
            ...
            i = h.textContent.indexOf(".", i),
                -1 === i ? i = h.length : i += 1,
                j = k.generateCfiFromTextNode(h, i, a.renderer.currentChapter.cfiBase),
                l = {
            ...
            var e = a.id
                , f = function() {
                var c, f, l, m, n = i.height, o = i.width, p = 225;
                j[e] || (j[e] = document.createElement("div"),
                ...
                p > n / 2.5 && (p = n / 2.5,
                    ...
                    popRect.height + m >= n - 25 ? (c.style.top = m - popRect.height + "px",
                        c.classList.add("above")) : c.classList.remove("above"),
                    l - popRect.width <= 0 ? (c.style.left = l + "px",
                        c.classList.add("left")) : c.classList.remove("left"),
                    l + popRect.width / 2 >= o ? (c.style.left = l - 300 + "px",
                        popRect = c.getBoundingClientRect(),
    ...
    EPUBJS.reader.ReaderController = function(a) {
        ...
        return document.addEventListener("keydown", p, !1),
            e.on("click", function(b) {
                h.next(),b.preventDefault()
            }),
            f.on("click", function(b) {
                h.prev(),b.preventDefault()
            }),
    ...
    EPUBJS.reader.SidebarController = function(a) {
        var b = this
            ...
            , f = function(a) {
            var c = a + "Controller";
            e != a && void 0 !== b[c] && (b[e + "Controller"].hide(),
                b[c].show(),
                e = a,
            ...
            return b || (b = 1),
                a.forEach(function(a) {
                    ...
                    d.id = "toc-" + a.id,
                        ...
                        d.appendChild(e),
                    a.subitems && a.subitems.length > 0 && (b++,
                        g = f(a.subitems, b),
